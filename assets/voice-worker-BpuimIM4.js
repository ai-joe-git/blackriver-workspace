...
var best_index : i32 = 0;`,`if (${e.getByIndices(`input_indices`)} ${t.selectLastIndex>0?`>=`:`>`} value) {
  ...
  }`}},$r=e=>{Zr(e.inputs),e.compute(Qr(e.inputs))}}),ti,$,ni,ri,ii,ai,oi,si,ci,li,ui,di,fi,pi,mi,hi,gi,_i,vi,yi,bi,xi,Si,Ci,wi,Ti,Ei,Di,Oi,ki,Ai,ji,Mi,Ni,Pi,Fi,Ii,Li,Ri,zi,Bi,Vi,Hi,Ui,Wi,Gi=a(()=>{"use strict";L(),B(),H(),J(),ti=(e,t,n,r,i,a,o)=>{let s=Math.ceil(t/4),c=``;c=typeof i==`string`?`${i}(a)`:i(`a`);let l=K(`inputData`,n,[s],4),u=q(`outputData`,r,[s],4),d=[{name:`vec_size`,type:`u32`}];return o&&d.push(...o),`
...
`,Ri=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,zi=e=>{let t=Sn(e.inputs[0].dataType);e.compute($(e.inputs[0],`FastGelu`,Ri,Li(t),void 0,e.inputs[0].dataType))},Bi=(e,t)=>{let n=Sn(e.inputs[0].dataType);return e.compute($(e.inputs[0],`ThresholdedRelu`,e=>`select(vec4<${n}>(0.0), ${e}, ${e} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${n}>(${t.alpha});`,t.cacheKey)),0},Vi=e=>{e.compute($(e.inputs[0],`Log`,`log`))},Hi=(e,t)=>`
...
`,Ui=e=>`quick_gelu_impl(${e})`,Wi=(e,t)=>{let n=Sn(e.inputs[0].dataType);e.compute($(e.inputs[0],`QuickGelu`,Ui,Hi(n,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),Ki,qi,Ji,Yi=a(()=>{"use strict";B(),J(),Gi(),Ki=e=>{if(e[0].dims.length!==3)throw Error(`input should have 3 dimensions`);if(![2560,5120,10240].includes(e[0].dims[2]))throw Error(`hidden state should be 2560, 5120 or 10240`);if(e[1].dims.length!==1)throw Error(`bias is expected to have 1 dimensions`);if(e[0].dims[2]!==e[1].dims[0])throw Error(`last dimension of input and bias are not the same`)},qi=e=>{let t=e[0].dims.slice();t[2]/=2;let n=K(`input`,e[0].dataType,e[0].dims,4),r=K(`bias`,e[0].dataType,[e[0].dims[2]],4),i=q(`output`,e[0].dataType,t,4),a=z.size(t)/4,o=xn(e[0].dataType);return{name:`BiasSplitGelu`,getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:t=>`
  ...
  ${t.mainStart()}
    ...
    ${i.setByOffset(`global_idx`,`valueLeft * geluRight`)}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes(`uniforms.vec_size`)}
        ${_}
      }`},Zi=(e,t,n,r,i,a,o=n.dataType)=>{let s=n.dims.map(Number),c=r.dims.map(Number),l=!z.areEqual(s,c),u=s,d=z.size(s),f=!1,p=!1,m=[l];if(l){let e=Lt.calcShape(s,c,!1);if(!e)throw Error(`Can't perform binary op on the given tensors`);u=e.slice(),d=z.size(u);let t=z.size(s)===1,n=z.size(c)===1,r=s.length>0&&s[s.length-1]%4==0,i=c.length>0&&c[c.length-1]%4==0;m.push(t),m.push(n),m.push(r),m.push(i);let a=1;for(let e=1;e<u.length;e++){let t=s[s.length-e];if(t===c[c.length-e])a*=t;else break}a%4==0?(p=!0,f=!0):(t||n||r||i)&&(f=!0)}else f=!0;return m.push(f),{name:e,shaderCache:{hint:t+m.map(e=>e.toString()).join(`_`),inputDependencies:[`rank`,`rank`]},getShaderSource:e=>Xi(e,s,c,u,f,l,p,i,n.dataType,r.dataType,o,a),getRunData:()=>({outputs:[{dims:u,dataType:o}],dispatchGroup:{x:Math.ceil(d/64/4)},programUniforms:[{type:12,data:Math.ceil(z.size(u)/4)},...U(s,c,u)]})}},Qi=(e,t,n,r,i,a)=>{e.compute(Zi(t,i??``,e.inputs[0],e.inputs[1],n,r,a))},$i=e=>{Qi(e,`Add`,(e,t)=>`${e}+${t}`)},ea=e=>{Qi(e,`Div`,(e,t)=>`${e}/${t}`)},ta=e=>{Qi(e,`Equal`,{scalar:(e,t)=>`u32(${e}==${t})`,vector:(e,t)=>`vec4<u32>(${e}==${t})`},void 0,void 0,9)},na=e=>{Qi(e,`Mul`,(e,t)=>`${e}*${t}`)},ra=e=>{let t=K(`input`,e.inputs[0].dataType,e.inputs[0].dims).type.value;Qi(e,`Pow`,{scalar:(e,t)=>`pow_custom(${e},${t})`,vector:(e,t)=>`pow_vector_custom(${e},${t})`},`
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},ia=e=>{Qi(e,`Sub`,(e,t)=>`${e}-${t}`)},aa=e=>{Qi(e,`Greater`,{scalar:(e,t)=>`u32(${e}>${t})`,vector:(e,t)=>`vec4<u32>(${e}>${t})`},void 0,void 0,9)},oa=e=>{Qi(e,`Less`,{scalar:(e,t)=>`u32(${e}<${t})`,vector:(e,t)=>`vec4<u32>(${e}<${t})`},void 0,void 0,9)},sa=e=>{Qi(e,`GreaterOrEqual`,{scalar:(e,t)=>`u32(${e}>=${t})`,vector:(e,t)=>`vec4<u32>(${e}>=${t})`},void 0,void 0,9)},ca=e=>{Qi(e,`LessOrEqual`,{scalar:(e,t)=>`u32(${e}<=${t})`,vector:(e,t)=>`vec4<u32>(${e}<=${t})`},void 0,void 0,9)}}),ua,da,fa,pa,ma,ha,ga=a(()=>{"use strict";L(),B(),H(),J(),ua=(e,t)=>{if(!e||e.length<1)throw Error(`too few inputs`);let n=e[0],r=n.dataType,i=n.dims.length;e.forEach((e,a)=>{if(a!==0){if(e.dataType!==r)throw Error(`input tensors should be one type`);if(e.dims.length!==i)throw Error(`input tensors should have the same shape`);e.dims.forEach((e,r)=>{if(r!==t&&e!==n.dims[r])throw Error(`non concat dimensions must match`)})}})},da=(e,t)=>`
...
`)},pa=(e,t,n,r)=>{let i=z.size(n),a=Array(e.length),o=Array(e.length),s=0,c=[],l=[],u=[{type:12,data:i}];for(let n=0;n<e.length;++n)s+=e[n].dims[t],a[n]=s,l.push(e[n].dims.length),o[n]=K(`input${n}`,r,l[n]),c.push(`rank`),u.push({type:12,data:a[n]});for(let t=0;t<e.length;++t)u.push(...U(e[t].dims));u.push(...U(n));let d=q(`output`,r,n.length),f=d.indicesGet(`indices`,t),p=Array.from(Array(a.length).keys()).map(e=>`uniforms.sizeInConcatAxis${e}`).join(`,`);return{name:`Concat`,shaderCache:{hint:`${t}`,inputDependencies:c},getRunData:()=>({outputs:[{dims:n,dataType:r}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:u}),getShaderSource:t=>`
  ...
  ${t.mainStart()}
    ...
    ${fa(o,d)}
  }`}},ma=(e,t)=>{let n=e.inputs,r=n[0].dims,i=z.normalizeAxis(t.axis,r.length);ua(n,i);let a=r.slice();a[i]=n.reduce((e,t)=>e+(t.dims.length>i?t.dims[i]:0),0);let o=n.filter(e=>z.size(e.dims)>0);e.compute(pa(o,i,a,n[0].dataType),{inputs:o})},ha=e=>V({axis:e.axis})}),_a,va,ya,ba,xa=a(()=>{"use strict";L(),B(),_a=(e,t,n=`f32`)=>{switch(e.activation){case`Relu`:return`value = max(value, ${t}(0.0));`;case`Sigmoid`:return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case`Clip`:return`value = clamp(value, ${t}(${n}(uniforms.clip_min)), ${t}(${n}(uniforms.clip_max)));`;case`HardSigmoid`:return`value = max(${t}(0.0), min(${t}(1.0), ${n}(uniforms.alpha) * value + ${n}(uniforms.beta)));`;case`LeakyRelu`:return`value = select(${n}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case`Tanh`:return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case``:return``;default:throw Error(`Unsupported activation ${e.activation}`)}},va=(e,t)=>{e.activation===`Clip`?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation===`HardSigmoid`?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation===`LeakyRelu`&&t.push({type:1,data:e.alpha})},ya=(e,t)=>{e.activation===`Clip`?t.push({name:`clip_max`,type:`f32`},{name:`clip_min`,type:`f32`}):e.activation===`HardSigmoid`?t.push({name:`alpha`,type:`f32`},{name:`beta`,type:`f32`}):e.activation===`LeakyRelu`&&t.push({name:`alpha`,type:`f32`})},ba=e=>{let t=e?.activation||``;if(t===`HardSigmoid`){let[n,r]=e?.activation_params||[.2,.5];return{activation:t,alpha:n,beta:r}}if(t===`Clip`){let[n,r]=e?.activation_params||[Bt,Vt];return{activation:t,clipMax:r,clipMin:n}}if(t===`LeakyRelu`){let[n]=e?.activation_params||[.01];return{activation:t,alpha:n}}return{activation:t}}}),Sa,Ca,wa=a(()=>{"use strict";Sa=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw Error(`${e}-component is not supported.`)}},Ca=e=>`
      ${e?`value = value + getBiasByOutputCoords(coords);`:``}
      `}),Ta,Ea=a(()=>{"use strict";Ta=e=>`
...
`}),Da,Oa,ka=a(()=>{"use strict";L(),B(),J(),xa(),Da=(e,t,n,r,i)=>{let a=r-n;return`
...
`},Oa=(e,t,n,r,i=!1,a)=>{let o=e[0].dims,s=e[1].dims,c=o[o.length-2],l=s[s.length-1],u=o[o.length-1],d=W(l),f=W(u),p=W(c),m=z.size(n)/d/p,h=e.length>2,g=r?r.slice(0,-2):n.slice(0,-2),_=[z.size(g),c,l],v=[{type:12,data:m},{type:12,data:c},{type:12,data:l},{type:12,data:u}];return va(t,v),v.push(...U(g,o,s)),h&&v.push(...U(e[2].dims)),v.push(...U(_)),{name:`MatMulNaive`,shaderCache:{hint:`${t.activation};${d};${f};${p};${i}`,inputDependencies:h?[`rank`,`rank`,`rank`]:[`rank`,`rank`]},getRunData:()=>({outputs:[{dims:a?a(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:v}),getShaderSource:r=>{let a=On(`batch_dims`,e[0].dataType,g.length),c=K(`a`,e[0].dataType,o.length,f),l=K(`b`,e[1].dataType,s.length,d),u=q(`output`,e[0].dataType,_.length,d),m=xn(u.type.tensor),v=_a(t,u.type.value,m),y=[c,l],b=``;if(h){let t=i?d:1;y.push(K(`bias`,e[2].dataType,e[2].dims.length,t)),b=`${i?`value += bias[col / ${t}];`:`value += ${u.type.value}(bias[row + i]);`}`}let x=[{name:`output_size`,type:`u32`},{name:`M`,type:`u32`},{name:`N`,type:`u32`},{name:`K`,type:`u32`}];ya(t,x);let S=()=>{let e=`var a_data: ${c.type.value};`;for(let t=0;t<f;t++)e+=`
...
`}return e};return`
  ...
  `}}}}),Aa,ja,Ma,Na,Pa,Fa,Ia,La,Ra=a(()=>{"use strict";L(),B(),J(),xa(),ka(),wa(),Aa=(e,t)=>e?`
...
`},Ia=(e,t,n,r,i=!1)=>{let[a,o,s,c]=r,l=xn(r[0].type.tensor);return`
  ...
  ${h?Ma(g,_,o,a):Fa(g,_,o,a)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${x}) {
    ...
    }`},Ba=(e,t,n,r,i,a,o,s,c)=>{let l=t.format===`NHWC`,u=l?e[0].dims[3]:e[0].dims[1],d=n[0],f=l?n[2]:n[3],p=l?n[1]:n[2],m=l?n[3]:n[1],h=l&&(u%4==0||u%3==0)&&m%4==0,g=l?m:f*p,_=l?f*p:m,v=[8,8,1],y=r<=8?[4,1,1]:[4,4,1],b=[Math.ceil(g/v[0]/y[0]),Math.ceil(_/v[1]/y[1]),Math.ceil(d/v[2]/y[2])];R(`verbose`,()=>`[conv2d_mm_webgpu] dispatch = ${b}`);let x=h?l&&u%4!=0?3:4:1,S=v[1]*y[1],C=v[0]*y[0],w=Math.max(v[0]*x,v[1]),ee=r%S===0,T=i%C===0,E=a%w===0,D=h?[x,4,4]:[1,1,1],O=[{type:6,data:r},{type:6,data:i},{type:6,data:a},{type:6,data:[t.pads[0],t.pads[1]]},{type:6,data:t.strides},{type:6,data:t.dilations}];va(t,O),O.push(...U(e[0].dims,e[1].dims));let k=[`rank`,`rank`];return o&&(O.push(...U(e[2].dims)),k.push(`rank`)),O.push(...U(n)),{name:`Conv2DMatMul`,shaderCache:{hint:`${t.cacheKey};${x};${h};${ee};${T};${E};${S};${C};${w}`,inputDependencies:k},getRunData:()=>({outputs:[{dims:c?c(n):n,dataType:e[0].dataType}],dispatchGroup:{x:b[0],y:b[1],z:b[2]},programUniforms:O}),getShaderSource:r=>{let i=[{name:`dim_a_outer`,type:`i32`},{name:`dim_b_outer`,type:`i32`},{name:`dim_inner`,type:`i32`},{name:`pad`,type:`i32`,length:2},{name:`stride`,type:`i32`,length:2},{name:`dilation`,type:`i32`,length:2}];ya(t,i);let a=h?4:1,c=xn(e[0].dataType),u=`
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${h?`vec4<${c}>`:c}) {
        ...
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${c} {
          ...
          }`}}}}),Za,Qa,$a=a(()=>{"use strict";L(),B(),J(),xa(),Za=(e,t,n,r)=>{let i=e.length>2,a=i?`value += b[output_channel];`:``,o=e[0].dims,s=e[1].dims,c=t.format===`NHWC`,l=c?n[3]:n[1],u=l/t.group,d=c&&u>=4?W(l):1,f=z.size(n)/d,p=[{type:12,data:f},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:u}];va(t,p),p.push(...U(o,[s[0],s[1],s[2],s[3]/d]));let m=i?[`rank`,`rank`,`rank`]:[`rank`,`rank`];return p.push(...U([n[0],n[1],n[2],n[3]/d])),{name:`GroupedConv`,shaderCache:{hint:`${t.cacheKey}_${d}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:r?r(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(f/64)},programUniforms:p}),getShaderSource:r=>{let l=q(`output`,e[0].dataType,n.length,d),u=xn(l.type.tensor),f=_a(t,l.type.value,u),p=K(`x`,e[0].dataType,o.length),m=K(`w`,e[1].dataType,s.length,d),h=[p,m];i&&h.push(K(`b`,e[2].dataType,e[2].dims,d));let g=[{name:`output_size`,type:`u32`},{name:`dilations`,type:`u32`,length:t.dilations.length},{name:`strides`,type:`u32`,length:2},{name:`pads`,type:`u32`,length:2},{name:`output_channels_per_group`,type:`u32`}];ya(t,g);let _=c?`
  ...
  ${n.mainStart()}
    ...
    ${x}}`}}}}),po,mo,ho,go,_o,vo,yo,bo,xo,So=a(()=>{"use strict";fo(),xa(),Bn(),po=(e,t,n,r,i,a)=>(e-1)*t+n+(r-1)*i+1-a,mo=(e,t,n,r,i)=>{let a=Math.floor(e/2);t===`SAME_UPPER`?(n[r]=a,n[i]=e-a):t===`SAME_LOWER`&&(n[r]=e-a,n[i]=a)},ho=(e,t,n,r,i,a,o,s,c,l)=>{let u=e.length-2,d=l.length===0;c.length<u&&c.push(...Array(u-c.length).fill(0));let f=e[0],p=t[s?3:1]*i;for(let i=0,f=e.length-u-+!!s;i<u;++i,++f){let s=e[f],p=d?s*o[i]:l[i],m=po(s,o[i],a[i],t[f],n[i],p);mo(m,r,a,i,i+u),d&&l.push(o[i]*(s-1)+c[i]+(t[f]-1)*n[i]+1-a[i]-a[i+u])}l.splice(0,0,f),l.splice(s?3:1,0,p)},go=(e,t)=>{let n=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((e,t)=>e*t,1)===0){n.length=0;for(let e=2;e<t[1].dims.length;++e)n.push(t[1].dims[e])}let r=e.format===`NHWC`;n.splice(0,0,t[1].dims[0]),n.splice(r?3:1,0,t[1].dims[1]);let i=e.pads.slice(),a=e.outputShape.slice(),o=e.outputPadding.slice(),s=t[0].dims,c=e.dilations.slice();if(c.reduce((e,t)=>e+t,0)===0){let e=t[0].dims.length-2;c=Array(e).fill(1)}let l=e.strides.slice();if(l.reduce((e,t)=>e+t,0)===0){let e=t[0].dims.length-2;l=Array(e).fill(1)}ho(s,n,c,e.autoPad,e.group,i,l,r,o,a);let u=Object.assign({},e);return Object.assign(u,{kernelShape:n,pads:i,outputPadding:o,outputShape:a,dilations:c,strides:l}),u},_o=e=>{let t=ba(e),n=e.format,r=[`NOTSET`,`VALID`,`SAME_UPPER`,`SAME_LOWER`][typeof e.autoPad>`u`?0:e.autoPad],i=e.dilations,a=e.group??1,o=e.kernelShape,s=e.pads,c=e.strides,l=e.wIsConst();return{autoPad:r,format:n,dilations:i,group:a,kernelShape:o,outputPadding:e.outputPadding,outputShape:e.outputShape,pads:s,strides:c,wIsConst:l,...t,cacheKey:`${e.format};${t.activation};`}},vo=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw Error(`Conv requires 2 or 3 inputs`);if(e[0].dims.length!==4&&e[0].dims.length!==3)throw Error(`currently only support 2-dimensional conv`);if(e[0].dims.length!==e[1].dims.length)throw Error(`filter does not have same dimension as input`);if(e[0].dims[t.format===`NHWC`?e[0].dims.length-1:1]!==e[1].dims[0])throw Error(`FILTER_IN_CHANNEL should be equal to DATA_CHANNEL`);let n=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==n))throw Error(`invalid bias`);let r=e[0].dims.length-2;if(t.dilations.reduce((e,t)=>e+t,0)>0&&t.dilations.length!==r)throw Error(`dilations should be ${r}D`);if(t.strides.reduce((e,t)=>e+t,0)>0&&t.strides.length!==r)throw Error(`strides should be ${r}D`);if(t.pads.reduce((e,t)=>e+t,0)>0&&t.pads.length!==r*2)throw Error(`pads should be ${r*2}D`);if(t.outputPadding.length!==r&&t.outputPadding.length!==0)throw Error(`output_padding should be ${r}D`);if(t.kernelShape.reduce((e,t)=>e+t,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw Error(`invalid kernel shape`);if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw Error(`invalid output shape`)},yo=(e,t,n,r)=>{let i=e.kernelCustomData.wT??e.compute(Ln(t[1],[2,3,0,1]),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=i);let a=[t[0],i];t.length===3&&a.push(t[2]),e.compute(uo(a,n,r),{inputs:a})},bo=(e,t)=>{let n=t.format===`NHWC`,r=[e.inputs[0].reshape(n?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let i=t.kernelShape;(i.length===0||i[0]===0)&&(i=[e.inputs[1].dims[2]]);let a=t.dilations;(a.length===0||a[0]===0)&&(a=[1]);let o=t.strides;(o.length===0||o[0]===0)&&(o=[1]);let s=t.pads;s.length===0&&(s=[0,0]),s=[0,s[0],0,s[1]],o=[1].concat(o),a=[1].concat(a),i=[1].concat(i);let c=t.outputPadding;c=[0].concat(c);let l=go({...t,pads:s,strides:o,dilations:a,kernelShape:i,outputPadding:c},r);yo(e,r,l,e=>n?[e[0],e[2],e[3]]:[e[0],e[1],e[3]])},xo=(e,t)=>{if(vo(e.inputs,t),e.inputs[0].dims.length===3)bo(e,t);else{let n=go(t,e.inputs);yo(e,e.inputs,n)}}}),Co,wo,To,Eo=a(()=>{"use strict";L(),B(),H(),J(),Co=(e,t,n,r)=>{let i=z.size(t),a=t.length,o=K(`input`,e,a),s=q(`output`,e,a),c=n.dataType===6?n.getInt32Array()[0]:Number(n.getBigInt64Array()[0]),l=z.normalizeAxis(c,a);return{name:`CumSum`,shaderCache:{hint:r.cacheKey,inputDependencies:[`rank`]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:[{type:12,data:i},{type:12,data:l},...U(t,t)]}),getShaderSource:e=>{let t=` i32(${o.indicesGet(`inputIndices`,`uniforms.axis`)}) `,n=G(`uniforms.input_shape`,`uniforms.axis`,a),i=r.reverse?t+(r.exclusive?` + 1`:``):`0`,c=r.reverse?n:t+(r.exclusive?``:` + 1`);return`
                ...
                }`}}},wo=(e,t)=>{let n=e.inputs[0].dims,r=e.inputs[0].dataType,i=e.inputs[1];e.compute(Co(r,n,i,t),{inputs:[0]})},To=e=>{let t=e.exclusive===1,n=e.reverse===1;return V({exclusive:t,reverse:n})}}),Do,Oo,ko,Ao,jo,Mo=a(()=>{"use strict";L(),B(),H(),J(),Do=e=>{if(!e||e.length!==1)throw Error(`DepthToSpace requires 1 input.`);if(e[0].dims.length!==4)throw Error(`DepthToSpace requires 4D input.`)},Oo=(e,t,n,r)=>{let i=[];i.push(`fn perm(i: ${r.type.indices}) -> ${n.type.indices} {
...
`)};
    ...
    ${e.mainStart()}
    ${e.guardAgainstOutOfBoundsWorkgroupSizes(`uniforms.vec_size`)}
    ${c}`},u=[{type:12,data:c},...U(t,r)];return{name:`Expand`,shaderCache:{hint:`${r.length};${o}${s}`,inputDependencies:[`rank`]},getShaderSource:l,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:u})}},Yo=e=>{Go(e.inputs),e.compute(Jo(e.inputs),{inputs:[0]})}}),Zo,Qo,$o=a(()=>{"use strict";L(),B(),J(),Gi(),Zo=e=>{let t=e[0].dataType,n=z.size(e[0].dims),r=z.size(e[1].dims),i=r%4==0;return{name:`FastGeluWithBias`,shaderCache:{hint:`${i}`,inputDependencies:[`type`,`type`]},getShaderSource:e=>{let n=K(`x`,t,[1],4),r=K(`bias`,t,[1],4),a=q(`y`,t,[1],4),o=[{name:`output_vec_size`,type:`u32`},{name:`bias_size`,type:`u32`}],s=e=>`
  ...
  ${e.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
        ...
        }`}},{inputs:[n[0],m]})},ss=e=>({batchDims:e.batch_dims,cacheKey:``})}),ls,us,ds,fs,ps=a(()=>{"use strict";L(),B(),H(),J(),ls=(e,t)=>{if(e.length<3||e.length>4)throw Error(`GatherBlockQuantized requires 3 or 4 inputs.`);let n=z.normalizeAxis(t.quantizeAxis,e[0].dims.length),r=t.blockSize,i=e[0],a=e[2],o=e.length===4?e[3]:void 0;if(a.dims.length!==i.dims.length||!i.dims.map((e,t)=>t===n?Math.ceil(e/r)===a.dims[t]:e===a.dims[t]).reduce((e,t)=>e&&t,!0))throw Error(`Scales must have the same rank as the input tensor and the dims should match except on gatherAxis.`);if(o){if(o.dataType!==i.dataType)throw Error(`Zero point must have the same data type as the input tensor.`);if(o.dims.length!==a.dims.length||!o.dims.map((e,t)=>e===a.dims[t]).reduce((e,t)=>e&&t,!0))throw Error(`Zero point must have the same rank as the input tensor and the dims should match except on quantizeAxis.`)}},us=(e,t)=>{let n=e[0].dims,r=e[1].dims,i=n.length,a=z.normalizeAxis(t.gatherAxis,i),o=z.normalizeAxis(t.quantizeAxis,i),s=n.slice(0);s.splice(a,1,...r);let c=z.size(s),l=e[2].dataType,u=e[0].dataType===22,d=[{type:12,data:c},{type:12,data:o},{type:12,data:a},{type:12,data:t.blockSize},...U(...e.map((e,t)=>e.dims),s)];return{name:`GatherBlockQuantized`,shaderCache:{hint:`${t.cacheKey};${e.filter((e,t)=>t!==1).map(e=>e.dims.join(`_`)).join(`;`)}`,inputDependencies:Array.from({length:e.length},(e,t)=>`rank`)},getRunData:()=>({outputs:[{dims:s,dataType:l}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:d}),getShaderSource:t=>{let i=K(`data`,e[0].dataType,e[0].dims.length),o=K(`inputIndices`,e[1].dataType,e[1].dims.length),c=K(`scales`,e[2].dataType,e[2].dims.length),d=e.length>3?K(`zeroPoint`,e[3].dataType,e[3].dims.length):void 0,f=q(`output`,l,s.length),p=[i,o,c];return d&&p.push(d),`
    ...
    }`}}},ds=(e,t)=>{let n=e.inputs;ls(n,t),e.compute(us(e.inputs,t))},fs=e=>V({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),ms,hs,gs,_s,vs=a(()=>{"use strict";L(),B(),H(),J(),ms=e=>{if(!e||e.length!==2)throw Error(`GatherElements requires 2 inputs.`);if(e[0].dims.length<1)throw Error(`GatherElements requires that the data input be rank >= 1.`);if(e[0].dims.length!==e[1].dims.length)throw Error(`GatherElements requires that the data input and
                     indices input tensors be of same rank.`)},hs=(e,t)=>{let n=e[0].dims,r=e[0].dataType,i=n.length,a=e[1].dims,o=e[1].dataType,s=z.normalizeAxis(t.axis,i),c=n[s],l=a.slice(0),u=z.size(l),d=K(`input`,r,i),f=K(`indicesInput`,o,a.length),p=q(`output`,r,l.length),m=[{type:12,data:u},{type:6,data:c},{type:12,data:s}];return m.push(...U(n,a,l)),{name:`GatherElements`,shaderCache:{inputDependencies:[`rank`,`rank`]},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:m}),getShaderSource:e=>`
  ...
  }`}}},xs=e=>({transA:e.transA,transB:e.transB,alpha:e.alpha,beta:e.beta,cacheKey:`${e.transA};${e.transB};${e.alpha===1}`}),Ss=(e,t)=>{ys(e.inputs),e.compute(bs(e.inputs,t))}}),ws,Ts,Es,Ds,Os,ks,As,js,Ms,Ns,Ps,Fs,Is,Ls,Rs=a(()=>{"use strict";L(),B(),H(),J(),[ws,Ts,Es,Ds]=[0,1,2,3],Os=e=>{if(e[0].dims.length!==4)throw Error(`only 4-D tensor is supported.`);if(e[0].dims.length!==e[1].dims.length)throw Error(`input dimensions must be equal to grid dimensions`);if(e[0].dims.length-2!==e[1].dims[e[1].dims.length-1])throw Error(`last dimension of grid must be equal to ${e[0].dims.length-2}`);if(e[0].dims[0]!==e[1].dims[0])throw Error(`grid batch size must match input batch size`)},ks=`
...
`,Ps=(e,t,n)=>(()=>{switch(n.mode){case`nearest`:return`
        ...
        `;default:throw Error(`mode ${n.mode} is not supported`)}})()+`${e.setByOffset(`global_idx`,`result`)}`,Fs=(e,t)=>{let n=K(`x`,e[0].dataType,e[0].dims.length),r=[e[1].dims[0],e[1].dims[1],e[1].dims[2]],i=K(`grid`,e[1].dataType,r.length,2),a=[e[0].dims[0],e[0].dims[1],e[1].dims[1],e[1].dims[2]];t.format===`NHWC`&&(a=[e[0].dims[0],e[1].dims[1],e[1].dims[2],e[0].dims[3]],[ws,Ts,Es,Ds]=[0,3,1,2]);let o=q(`output`,e[0].dataType,a.length),s=n.type.value,c=[{type:12,data:z.size(a)},...U(e[0].dims,r,a)];return{name:`GridSample`,shaderCache:{hint:`${t.cacheKey}`,inputDependencies:[`type`,`type`]},getRunData:e=>{let t=z.size(a);return{outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(t/64)},programUniforms:c}},getShaderSource:e=>`
  ...
  }`}},{inputs:[t,n],outputs:[-1]})[0]},Ws=(e,t,n,r,i,a,o,s)=>{let c=a;if(o&&z.size(o.dims)>0){if(r===1)throw Error(`AddBiasReshape is not implemented. Please export your model with packed QKV or KV`);return c=Us(e,a,o,t,r,n*i,s),c=c.reshape([t,r,n,i]),n===1||r===1?c:e.compute(Ln(c,Hs.perm),{inputs:[c],outputs:[-1]})[0]}return a.dims.length===3&&(c=a.reshape([t,r,n,i])),n===1||r===1?c:e.compute(Ln(c,Hs.perm),{inputs:[c],outputs:[-1]})[0]},Gs=(e,t)=>{let n=Bs(e.inputs,t),r=e.inputs[0],i=zs(e.inputs,1),a=zs(e.inputs,2),o=zs(e.inputs,3),s=zs(e.inputs,4),c=zs(e.inputs,5),l=zs(e.inputs,6),u=zs(e.inputs,7);if(r.dims.length===5)throw Error(`Packed QKV is not implemented`);if(i?.dims.length===5)throw Error(`Packed KV is not implemented`);let d=i&&a&&i.dims.length===4&&a.dims.length===4,f=Ws(e,n.batchSize,n.numHeads,n.sequenceLength,n.headSize,r,o,0);if(d)return Hr(e,f,i,a,s,void 0,l,u,c,n);if(!i||!a)throw Error(`key and value must be provided`);let p=Ws(e,n.batchSize,n.numHeads,n.kvSequenceLength,n.headSize,i,o,n.hiddenSize),m=Ws(e,n.batchSize,n.numHeads,n.kvSequenceLength,n.vHeadSize,a,o,2*n.hiddenSize);Hr(e,f,p,m,s,void 0,l,u,c,n)}}),qs,Js,Ys,Xs,Zs,Qs,$s,ec=a(()=>{"use strict";L(),B(),H(),J(),qs=e=>{if(!e||e.length<1)throw Error(`too few inputs`)},Js=(e,t)=>{let n=[],r=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(e=>n.push(Number(e))),r=n.length),V({numOutputs:r,axis:t.axis,splitSizes:n})},Ys=e=>`
fn calculateOutputIndex(index: u32) -> u32 {
    ...
    return ${e}u;
      ...
      fn writeBufferData(output_number: u32, indices: ${e[0].type.indices}, global_idx: u32) {
        ${n.join(`
`)}
      }`},Zs=(e,t)=>{let n=e[0].dims,r=z.size(n),i=e[0].dataType,a=z.normalizeAxis(t.axis,n.length),o=Array(t.numOutputs),s=K(`input`,i,n.length),c=Array(t.numOutputs),l=[],u=[],d=0,f=[{type:12,data:r}];for(let r=0;r<t.numOutputs;r++){d+=t.splitSizes[r],c[r]=d;let s=n.slice();s[a]=t.splitSizes[r],u.push(s),o[r]=q(`output${r}`,i,s.length),l.push({dims:u[r],dataType:e[0].dataType})}return f.push({type:12,data:c},...U(n,...u)),{name:`Split`,shaderCache:{hint:t.cacheKey,inputDependencies:[`rank`]},getShaderSource:e=>`
  ...
  `}}},lc=(e,t)=>{let n=ac(e.inputs,t);if(e.inputs[0].dims.length===5)throw Error(`Packed QKV is not implemented`);if(e.inputs[1]?.dims.length===5)throw Error(`Packed KV is not implemented`);let r=e.inputs[0],i=e.inputs[1]&&e.inputs[1].dims.length>0?e.inputs[1]:void 0,a=e.inputs[2]&&e.inputs[2].dims.length>0?e.inputs[2]:void 0,o=e.inputs[3]&&e.inputs[3].dims.length!==0?e.inputs[3]:void 0,s=e.inputs[4]&&e.inputs[4].dims.length!==0?e.inputs[4]:void 0,c=e.inputs.length>4?e.inputs[5]:void 0,l=e.inputs.length>5?e.inputs[6]:void 0,u=n.kvNumHeads?n.kvNumHeads:n.numHeads,d=V({axis:2,numOutputs:3,splitSizes:[n.numHeads*n.headSize,u*n.headSize,u*n.headSize]}),[f,p,m]=!i&&!a?e.compute(Zs([r],d),{inputs:[r],outputs:[-1,-1,-1]}):[r,i,a],h,g;if(t.doRotary){let r=e.compute(cc(n.batchSize,n.sequenceLength,c,l),{inputs:[c,l],outputs:[-1]})[0],i=e.inputs[7],a=e.inputs[8],o=V({interleaved:t.rotaryInterleaved!==0,numHeads:n.numHeads,rotaryEmbeddingDim:0,scale:t.scale}),s=[f,r,i,a],u=[-1];h=e.compute(nc(s,o),{inputs:s,outputs:u})[0],s.splice(0,1,p);let d=V({interleaved:t.rotaryInterleaved!==0,numHeads:n.kvNumHeads,rotaryEmbeddingDim:0,scale:t.scale});g=e.compute(nc(s,d),{inputs:s,outputs:u})[0]}let _=Ws(e,n.batchSize,n.numHeads,n.sequenceLength,n.headSize,t.doRotary?h:f,void 0,0),v=sc(e,t.doRotary?g:p,n),y=sc(e,m,n);Hr(e,_,v,y,void 0,void 0,o,s,void 0,n,c,l)}}),dc,fc,pc,mc,hc=a(()=>{"use strict";L(),B(),Bn(),J(),dc=(e,t,n,r,i,a,o,s)=>{let c=W(a),l=c===1?`f32`:`vec${c}f`,u=c===1?`vec2f`:`mat2x${c}f`,d=i*o,f=64;d===1&&(f=256);let p=[i,o,a/c],m=[i,o,2],h=[`rank`,`type`,`type`],g=[];return g.push(...U(p,m)),e.compute({name:`InstanceNormComputeChannelScaleShift`,shaderCache:{hint:`${c};${s};${f}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:m,dataType:1}],dispatchGroup:{x:d},programUniforms:g}),getShaderSource:e=>{let i=K(`x`,t.dataType,3,c),a=[i,K(`scale`,n.dataType,n.dims),K(`bias`,r.dataType,r.dims),q(`output`,1,3,2)];return`
  ...
  }`}},{inputs:[t,n,r],outputs:[-1]})[0]},fc=(e,t,n)=>{let r=t[0].dims,i=r,a=r[0],o=r[1],s=z.sizeFromDimension(r,2),c=W(s),l=z.size(i)/c,u=dc(e,t[0],t[1],t[2],a,s,o,n.epsilon),d=[a,o,s/c],f=[a,o];e.compute({name:`InstanceNormalization`,shaderCache:{hint:`${c}`,inputDependencies:[`type`,`none`]},getRunData:()=>({outputs:[{dims:i,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:[{type:12,data:l},...U(d,f,d)]}),getShaderSource:e=>{let n=K(`x`,t[0].dataType,d.length,c),r=K(`scale_shift`,1,f.length,2),i=q(`output`,t[0].dataType,d.length,c),a=[n,r,i];return`
  ...
  }`}},{inputs:[t[0],h]})},mc=(e,t)=>{t.format===`NHWC`?pc(e,e.inputs,t):fc(e,e.inputs,t)}}),gc,_c,vc,yc=a(()=>{"use strict";L(),B(),J(),gc=e=>{if(!e||e.length<2)throw Error(`layerNorm requires at least 2 inputs.`)},_c=(e,t,n)=>{let r=t.simplified,i=e[0].dims,a=e[1],o=!r&&e[2],s=i,c=z.normalizeAxis(t.axis,i.length),l=z.sizeToDimension(i,c),u=z.sizeFromDimension(i,c),d=z.size(a.dims),f=o?z.size(o.dims):0;if(d!==u||o&&f!==u)throw Error(`Size of X.shape()[axis:] == ${u}.
  ...
  ${t.mainStart()}
    ...
    ${v?`inv_std_output[global_idx] = inv_std_dev`:``};
  }`},b=[{dims:s,dataType:e[0].dataType}];return _&&b.push({dims:p,dataType:1}),v&&b.push({dims:p,dataType:1}),{name:`LayerNormalization`,shaderCache:{hint:`${m};${n};${r}`,inputDependencies:h},getRunData:()=>({outputs:b,dispatchGroup:{x:Math.ceil(l/64)},programUniforms:g}),getShaderSource:y}},vc=(e,t)=>{gc(e.inputs),e.compute(_c(e.inputs,t,e.outputCount))}}),bc,xc,Sc=a(()=>{"use strict";B(),ka(),Ra(),bc=e=>{if(!e||e.length!==2)throw Error(`MatMul requires 2 inputs.`);if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw Error(`shared dimension does not match.`)},xc=e=>{bc(e.inputs);let t=Lt.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw Error(`Can't use matmul on the given tensors`);let n=t[t.length-1],r=e.inputs[0].dims[e.inputs[0].dims.length-1];if(n<8&&r<8)e.compute(Oa(e.inputs,{activation:``},t));else{let i=t[t.length-2],a=z.size(e.inputs[0].dims.slice(0,-2)),o=z.size(e.inputs[1].dims.slice(0,-2));if(a!==1&&i===1&&o===1){let i=e.inputs[0].reshape([1,a,r]),o=e.inputs[1].reshape([1,r,n]),s=[1,a,n],c=[i,o];e.compute(La(c,{activation:``},t,s),{inputs:c})}else e.compute(La(e.inputs,{activation:``},t))}}}),Cc,wc,Tc,Ec,Dc,Oc=a(()=>{"use strict";L(),B(),H(),J(),Cc=(e,t)=>{if(e.length<3||e.length>4)throw Error(`MatMulNBits requires 3 or 4 inputs`);let n=e[0],r=n.dims.length;if(n.dims[r-1]!==t.k)throw Error(`The last dim of input shape does not match the k value`);let i=Math.floor((t.k+t.blockSize-1)/t.blockSize),a=t.blockSize/8*t.bits,o=e[1];if(!z.areEqual(o.dims,[t.n,i,a]))throw Error(`The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize`);let s=e[2].dims;if(z.size(s)!==t.n*i)throw Error(`scales input size error.`);if(e.length===4){let n=e[3].dims,r=t.n*(t.bits===8?i:Math.floor((i*t.bits+7)/8));if(z.size(n)!==r)throw Error(`zeroPoints input size error.`)}},wc=(e,t)=>{let n=e[0].dims,r=n.length,i=n[r-2],a=t.k,o=t.n,s=n.slice(0,r-2),c=z.size(s),l=e[1].dims[2]/4,u=e[0].dataType,d=W(t.k),f=W(l),p=W(o),m=s.concat([i,o]),h=i>1&&o/p%2==0?2:1,g=z.size(m)/p/h,_=[],v=[c,i,a/d],y=z.convertShape(e[1].dims).slice();y.splice(-1,1,l/f),_.push(...U(v)),_.push(...U(y)),_.push(...U(e[2].dims)),e.length===4&&_.push(...U(z.convertShape(e[3].dims)));let b=[c,i,o/p];return _.push(...U(b)),{name:`MatMulNBits`,shaderCache:{hint:`${t.blockSize};${t.bits};${d};${f};${p};${h};64`,inputDependencies:Array(e.length).fill(`rank`)},getRunData:()=>({outputs:[{dims:m,dataType:u}],dispatchGroup:{x:g},programUniforms:_}),getShaderSource:n=>{let r=v.length,i=K(`a`,e[0].dataType,r,d),a=K(`b`,12,y.length,f),o=K(`scales`,e[2].dataType,e[2].dims.length),s=[i,a,o],c=e.length===4?K(`zero_points`,12,e[3].dims.length):void 0;c&&s.push(c);let u=b.length,m=q(`output`,e[0].dataType,u,p),g=xn(e[0].dataType),_=(()=>{switch(d){case 1:return`array<${g}, 8>`;case 2:return`mat4x2<${g}>`;case 4:return`mat2x4<${g}>`;default:throw Error(`${d}-component is not supported.`)}})(),x=Math.floor(32/t.bits),S=Math.floor(x/8),C=()=>{let e=``;for(let n=0;n<S;n++){let r=n*t.bits*4,a=r+t.bits;e+=`
          // reuse a data (pass ${n})
        ...
        }`}}},Ec=(e,t)=>{Cc(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor(`intel`)&&e.adapterInfo.isArchitecture(`gen-12lp`)?e.compute(Tc(e.inputs,t)):e.compute(wc(e.inputs,t))},Dc=e=>V(e)}),kc,Ac,jc,Mc,Nc,Pc,Fc,Ic,Lc,Rc=a(()=>{"use strict";L(),B(),J(),kc=e=>{if(!e||e.length<1)throw Error(`Too few inputs`);if(e[0].dataType!==1&&e[0].dataType!==10)throw Error(`Input type must be float or float16.`);if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw Error(`The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].`)}},Ac=(e,t,n)=>{let r=``;for(let i=t-1;i>=0;--i)r+=`
    ...
    `,``,t.dataType===10?-65504:-1e5,l,u,d,f)}},el=(e,t)=>{zc(e.inputs),e.compute($c(`MaxPool`,e.inputs[0],!1,t))},tl=e=>{let t=e.storage_order,n=e.dilations,r=Kc(e);if(t!==0)throw Error(`column major storage order is not yet supported for MaxPool`);if(r.ceilMode!==0)throw Error(`using ceil() in shape computation is not yet supported for MaxPool`);let i={storageOrder:t,dilations:n,...r,cacheKey:``};return{...i,cacheKey:Gc(i)}},nl=e=>{let t=e.format;return{format:t,...Xc,cacheKey:t}},rl=(e,t)=>{zc(e.inputs),e.compute($c(`GlobalMaxPool`,e.inputs[0],!0,t))}}),al,ol,sl,cl,ll=a(()=>{"use strict";L(),B(),H(),J(),al=(e,t)=>{if(e.length<2||e.length>3)throw Error(`DequantizeLinear requires 2 or 3 inputs.`);if(e.length===3&&e[1].dims===e[2].dims)throw Error(`x-scale and x-zero-point must have the same shape.`);if(e.length===3&&e[0].dataType!==e[2].dataType)throw Error(`x and x-zero-point must have the same data type.`);if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw Error(`scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.`);if(e.length>2){if(e[0].dataType!==e[2].dataType)throw Error(`x and x-zero-point must have the same data type.`);if(e[1].dims.length!==e[2].dims.length)throw Error(`scale and zero-point inputs must have the same rank.`);if(!e[1].dims.map((t,n)=>t===e[2].dims[n]).reduce((e,t)=>e&&t,!0))throw Error(`scale and zero-point inputs must have the same shape.`)}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw Error(`blockSize must be set only for block quantization.`);if(!e[1].dims.map((n,r)=>r===t.axis||n===e[0].dims[r]).reduce((e,t)=>e&&t,!0))throw Error(`For block qunatization, scale input shape to match the input shape except for the axis`);if(e[1].dims.length!==e[0].dims.length)throw Error(`For block qunatization the scale input rank must be the same as the x rank.`);let n=e[0].dims[t.axis],r=e[1].dims[t.axis];if(t.blockSize<Math.ceil(n/r)||t.blockSize>Math.ceil(n/(r-1)-1))throw Error(`blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].`)}},ol=(e,t)=>{let n=z.normalizeAxis(t.axis,e[0].dims.length),r=e[0].dataType,i=r===3,a=e[0].dims,o=e[1].dataType,s=z.size(a),c=r===3||r===2,l=c?[Math.ceil(z.size(e[0].dims)/4)]:e[0].dims,u=e[1].dims,d=e.length>2?e[2]:void 0,f=d?c?[Math.ceil(z.size(d.dims)/4)]:d.dims:void 0,p=u.length===0||u.length===1&&u[0]===1,m=p===!1&&u.length===1,h=W(s),g=p&&(!c||h===4),_=g?h:1,v=g&&!c?h:1,y=K(`input`,c?12:r,l.length,v),b=K(`scale`,o,u.length),x=d?K(`zero_point`,c?12:r,f.length):void 0,S=q(`output`,o,a.length,_),C=[y,b];x&&C.push(x);let w=[l,u];d&&w.push(f);let ee=[{type:12,data:s/_},{type:12,data:n},{type:12,data:t.blockSize},...U(...w,a)];return{name:`DequantizeLinear`,shaderCache:{hint:t.cacheKey,inputDependencies:x?[`rank`,`rank`,`rank`]:[`rank`,`rank`]},getShaderSource:e=>`
      ...
      }`,getRunData:()=>({outputs:[{dims:a,dataType:o}],dispatchGroup:{x:Math.ceil(s/_/64),y:1,z:1},programUniforms:ee})}},sl=(e,t)=>{al(e.inputs,t),e.compute(ol(e.inputs,t))},cl=e=>V({axis:e.axis,blockSize:e.blockSize})}),ul,dl,fl,pl=a(()=>{"use strict";Ee(),L(),J(),ul=(e,t,n)=>{if(e===t||e<t&&n<0||e>t&&n>0)throw Error(`Range these inputs' contents are invalid.`)},dl=(e,t,n,r)=>{let i=Math.abs(Math.ceil((t-e)/n)),a=[i],o=i,s=[{type:12,data:o},{type:r,data:e},{type:r,data:n},...U(a)];return{name:`Range`,shaderCache:{hint:`${r}`},getShaderSource:e=>{let t=q(`output`,r,a.length),n=t.type.value,i=[{name:`outputSize`,type:`u32`},{name:`start`,type:n},{name:`delta`,type:n}];return`
        ${e.registerUniforms(i).declareVariables(t)}
        ${e.mainStart()}
        ${e.guardAgainstOutOfBoundsWorkgroupSizes(`uniforms.outputSize`)}
        output[global_idx] = uniforms.start + ${n}(global_idx) * uniforms.delta;
      }`},getRunData:()=>({outputs:[{dims:a,dataType:r}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:s})}},fl=e=>{let t=0,n=0,r=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],n=e.inputs[1].getInt32Array()[0],r=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],n=e.inputs[1].getFloat32Array()[0],r=e.inputs[2].getFloat32Array()[0]),x.webgpu.validateInputContent&&ul(t,n,r),e.compute(dl(t,n,r,e.inputs[0].dataType),{inputs:[]})}}),ml,hl,gl,_l,vl=a(()=>{"use strict";L(),B(),H(),J(),ml=(e,t,n,r)=>{if(e!==`none`&&r!==`i32`&&r!==`u32`&&r!==`f32`)throw Error(`Input ${r} is not supported with reduction ${e}.`);let i=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,a=`;
...
`,Cl=(e,t)=>`fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${t} { `+(()=>{switch(e){case`asymmetric`:return`
        ...
        `;case`pytorch_half_pixel`:return`if (lengthResized > 1) {
                  ...
                  return offset + ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;case`half_pixel`:return`return ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;default:throw Error(`Coordinate transform mode ${e} is not supported`)}})()+`}`,wl=(e,t,n)=>`fn getNearestPixelFromOriginal(xOriginal: ${n}, isDownSample: bool) -> ${n} {`+(()=>{switch(e){case`round_prefer_ceil`:return`if (fract(xOriginal) == 0.5) {             return ceil(xOriginal);           } else {             return round(xOriginal);           }`;case`floor`:return`return floor(xOriginal);`;case`ceil`:return`return ceil(xOriginal);`;case`round_prefer_floor`:return`if (fract(xOriginal) == 0.5) {                     return floor(xOriginal);                   } else {                     return round(xOriginal);                   }`;default:if(t<11)return`if (isDownSample)                     {                       return ceil(xOriginal);                     } else {                       return xOriginal;                     }`;throw Error(`Nearest mode ${e} is not supported`)}})()+`}`,Tl=(e,t,n)=>{let r=Array(n).fill(0).concat(Array(n).fill(1)),i=e.length===0?r:e.slice();return t.length>0?(t.forEach((e,a)=>{r[e]=i[a],r[a+n]=i[t.length+a]}),r):i},El=(e,t,n,r)=>{let i=[];if(n.length>0){if(r.length>0){if(e.forEach(e=>i.push(e)),Math.max(...r)>e.length)throw Error(`axes is out of bound`);r.forEach((e,t)=>i[e]=n[t])}else n.forEach(e=>i.push(e))}else{if(t.length===0)throw Error(`Resize requires either scales or sizes.`);i=e.map((e,n)=>Math.round(e*t[n]))}return i},Dl=(e,t,n)=>{let r=(()=>{switch(n.keepAspectRatioPolicy){case`not_larger`:return n.axes.length>0?Math.min(...n.axes.map(e=>t[e]),Number.MAX_VALUE):Math.min(...t,Number.MAX_VALUE);case`not_smaller`:return n.axes.length>0?Math.max(...n.axes.map(e=>t[e]),Number.MIN_VALUE):Math.max(...t,Number.MIN_VALUE);default:throw Error(`Keep aspect ratio policy ${n.keepAspectRatioPolicy} is not supported`)}})();t.fill(1,0,t.length);let i=e.slice();return n.axes.length>0?(n.axes.forEach(e=>t[e]=r),n.axes.forEach(n=>i[n]=Math.round(e[n]*t[n]))):(t.fill(r,0,t.length),i.forEach((e,n)=>i[n]=Math.round(e*t[n]))),i},Ol=(e,t,n,r,i)=>`
...
`:``,Ml=(e,t,n,r,i)=>{let[a,o,s,c]=n.length===2?[-1,0,1,-1]:[0,2,3,1],l=e.type.value;return`
    ...
    }`},Nl=(e,t,n,r,i,a,o,s,c,l)=>{let[u,d]=n.length===2?[0,1]:[2,3],f=e.type.value,p=o=>{let d=o===u?`row`:`col`;return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${f} {
    ...
    `},Pl=(e,t,n,r,i)=>{let[a,o,s,c,l]=n.length===3?[-1,0,1,2,-1]:[0,2,3,4,1],u=e.type.value;return`
    ...
    }`},Fl=(e,t,n,r,i,a)=>{let o=e.dims,s=Tl(a,t.axes,o.length),c=El(o,r,i,t.axes),l=r.slice();r.length===0&&(l=o.map((e,t)=>e===0?1:c[t]/e),t.keepAspectRatioPolicy!==`stretch`&&(c=Dl(o,l,t)));let u=q(`output`,e.dataType,c.length),d=K(`input`,e.dataType,o.length),f=z.size(c),p=o.length===c.length&&o.every((e,t)=>e===c[t]),m=t.coordinateTransformMode===`tf_crop_and_resize`,h=t.extrapolationValue,g=d.type.value;return{name:`Resize`,shaderCache:{hint:`${t.cacheKey}|${n}|${l.length>0?t.mode===`cubic`?l:l.length:``}|${i.length>0?i:``}|${s.length>0?s:``}|${p}|${t.mode===`nearest`?o.length:o}`,inputDependencies:[`rank`]},getShaderSource:e=>`
      ${p?``:`
      ${Cl(t.coordinateTransformMode,g)};
      ${(()=>{switch(t.mode){case`nearest`:return`
              ${Al(d,o)};
              ${wl(t.nearestMode,n,g)};
              ${kl(d,u,o,c,l.length,s.length,m)};
              `;case`linear`:return`
              ${Ol(u,o,c,l.length,s.length)};
              ${(()=>{if(o.length===2||o.length===4)return`${Ml(d,u,o,m,h)}`;if(o.length===3||o.length===5)return`${Pl(d,u,o,m,h)}`;throw Error(`Linear mode only supports input dims 2, 3, 4 and 5 are supported in linear mode.`)})()};
            `;case`cubic`:return`
            ${(()=>{if(o.length===2||o.length===4)return`${Nl(d,u,o,c,l,s,t.cubicCoeffA,m,t.extrapolationValue,t.excludeOutside)}`;throw Error(`Cubic mode only supports input dims 2 and 4 are supported in linear mode.`)})()};
...
`}
      ...
      }`},y=[{dims:s,dataType:e[0].dataType}];return n>1&&y.push({dims:u,dataType:1}),n>2&&y.push({dims:u,dataType:1}),n>3&&y.push({dims:a,dataType:e[0].dataType}),{name:`SkipLayerNormalization`,shaderCache:{hint:`${g};${p};${m};${h}`,inputDependencies:e.map((e,t)=>`type`)},getShaderSource:v,getRunData:()=>({outputs:y,dispatchGroup:{x:Math.ceil(c/l)},programUniforms:_})}},Hl=(e,t)=>{Bl(e.inputs);let n=[0];e.outputCount>1&&n.push(-3),e.outputCount>2&&n.push(-3),e.outputCount>3&&n.push(3),e.compute(Vl(e.inputs,t,e.outputCount,!1),{outputs:n})}}),Wl,Gl,Kl,ql,Jl,Yl,Xl,Zl,Ql=a(()=>{"use strict";L(),B(),H(),J(),Wl=(e,t)=>{if(!e||e.length<1)throw Error(`too few inputs`);if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw Error(`axes, starts and ends must have the same length`)}else if(t.starts.length!==t.ends.length)throw Error(`starts and ends must have the same length`);e.slice(1).forEach((t,n)=>{if(e[n+1].dataType!==6&&e[n+1].dataType!==7)throw Error(`Input ${n} must be an array of int32 or int64`)})},Gl=(e,t)=>{let n=[];if(e.length>t){if(e[t].dataType===7)e[t].getBigInt64Array().forEach(e=>n.push(Number(e)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(e=>n.push(Number(e)));else throw Error(`Input ${t} must be an array of int32 or int64`)}return n},Kl=(e,t)=>{if(e.length>1){let t=Gl(e,1),n=Gl(e,2),r=Gl(e,3);return r.length===0&&(r=[...Array(e[0].dims.length).keys()]),V({starts:t,ends:n,axes:r})}return t},ql=(e,t,n,r,i)=>{let a=e;return e<0&&(a+=n[r[t]]),i[t]<0?Math.max(0,Math.min(a,n[r[t]]-1)):Math.max(0,Math.min(a,n[r[t]]))},Jl=(e,t,n)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      }`},{inputs:[c],outputs:[s?-1:0]})[0];s&&e.compute(Ln(x,l),{inputs:[x]})},tu=(e,t)=>{$l(e.inputs),eu(e,t)},nu=e=>V({axis:e.axis})}),iu,au,ou,su,cu,lu=a(()=>{"use strict";L(),B(),J(),iu=e=>Array.from(e.getBigInt64Array(),Number),au=e=>{if(!e||e.length!==2)throw Error(`Tile requires 2 inputs.`);if(e[0].dataType!==1&&e[0].dataType!==10&&e[0].dataType!==6&&e[0].dataType!==12)throw Error(`Tile only support float, float16, int32, and uint32 data types`);if(e[1].dataType!==7)throw Error("Tile `repeats` input should be of int64 data type");if(e[1].dims.length!==1)throw Error("Tile `repeats` input should be 1-D");if(iu(e[1]).length!==e[0].dims.length)throw Error("Tile `repeats` input should have same number of elements as rank of input data tensor")},ou=(e,t)=>{let n=[];for(let r=0;r<e.length;++r)n.push(e[r]*t[r]);return n},su=(e,t)=>{let n=e[0].dims,r=t??iu(e[1]),i=ou(n,r),a=z.size(i),o=e[0].dataType,s=K(`input`,o,n.length),c=q(`output`,o,i.length);return{name:`Tile`,shaderCache:{hint:`${r}`,inputDependencies:[`rank`]},getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:[{type:12,data:a},...U(e[0].dims,i)]}),getShaderSource:e=>`
    ...
    }`}},cu=e=>{au(e.inputs),e.compute(su(e.inputs),{inputs:[0]})}}),uu,du,fu,pu=a(()=>{"use strict";L(),B(),J(),uu=(e,t,n,r,i)=>{let a=q(`output_data`,i,n.length,4),o=K(`a_data`,t[1].dataType,t[1].dims.length,4),s=K(`b_data`,t[2].dataType,t[2].dims.length,4),c=K(`c_data`,t[0].dataType,t[0].dims.length,4),l,u=(e,t,n)=>`select(${t}, ${e}, ${n})`;if(!r)l=a.setByOffset(`global_idx`,u(o.getByOffset(`global_idx`),s.getByOffset(`global_idx`),c.getByOffset(`global_idx`)));else{let e=(e,t,n=``)=>{let r=`a_data[index_a${t}][component_a${t}]`,i=`b_data[index_b${t}][component_b${t}]`,l=`bool(c_data[index_c${t}] & (0xffu << (component_c${t} * 8)))`;return`
...
* =============================================================================
*/
var vd=1380533830,yd=1463899717,bd=1718449184,xd=1684108385;function Sd(e,t){return e.getUint32(t,!1)}function Cd(e,t){return{audioFormat:e.getUint16(t+8,!0),channels:e.getUint16(t+10,!0),sampleRate:e.getUint32(t+12,!0),bitsPerSample:e.getUint16(t+22,!0)}}function wd(e,t,n,r){let{audioFormat:i,channels:a,bitsPerSample:o}=r,s=o/8,c=n/s/a,l=new Float32Array(c);for(let n=0;n<c;n+=1){let r=0;for(let c=0;c<a;c+=1){let l=t+(n*a+c)*s,u;if(i===1&&o===16)u=e.getInt16(l,!0)/32768;else if(i===1&&o===32)u=e.getInt32(l,!0)/2147483648;else if(i===3&&o===32)u=e.getFloat32(l,!0);else throw Error(`Unsupported WAV format: audioFormat=${i}, bitsPerSample=${o}`);r+=u}l[n]=r/a}return l}function Td(e){let t=new DataView(e);if(Sd(t,0)!==vd||Sd(t,8)!==yd)throw Error(`Invalid WAV file header.`);let n=12,r=null,i=-1,a=0;for(;n+8<=t.byteLength;){let e=Sd(t,n),o=t.getUint32(n+4,!0);if(e===bd)r=Cd(t,n);else if(e===xd){i=n+8,a=o;break}n+=8+o+o%2}if(!r)throw Error(`WAV file is missing fmt chunk.`);if(i<0)throw Error(`WAV file is missing data chunk.`);let o=wd(t,i,a,r);return{sampleRate:r.sampleRate,samples:o}}function Ed(e,t,n){if(t===n)return e;let r=t/n,i=Math.max(1,Math.floor(e.length/r)),a=new Float32Array(i);for(let t=0;t<i;t+=1){let n=t*r,i=Math.floor(n),o=Math.min(i+1,e.length-1),s=n-i;a[t]=e[i]*(1-s)+e[o]*s}return a}function Dd(e){let t=0;for(let n=0;n<e.length;n+=1)t+=e[n];let n=t/e.length,r=0;for(let t=0;t<e.length;t+=1){let i=e[t]-n;r+=i*i}let i=Math.sqrt(r/e.length)+1e-5,a=new Float32Array(e.length);for(let t=0;t<e.length;t+=1)a[t]=(e[t]-n)/i;return a}function Od(e){return BigInt64Array.from(e.map(e=>BigInt(e)))}function kd(e){if(!e||!e.data||e.data.length===0)throw Error(`Expected scalar tensor with data.`);let t=e.data[0];if(typeof t==`bigint`)return Number(t);if(typeof t==`number`)return t;throw Error(`Expected numeric scalar tensor, received ${typeof t}.`)}function Ad(e,t,n){for(let n of t)if(e.inputNames.includes(n))return n;return e.inputNames[n]}function jd(e,t,n){return e===`int64`?new j(`int64`,Od(t),n):new j(`int32`,Int32Array.from(t),n)}function Md(e,t,n){let r=e.outputNames[n],i=t[r];if(!i)throw Error(`Missing output tensor at index ${n} (${r}).`);return i}function Nd(e){return typeof e==`bigint`||typeof e==`string`?Number(e):e}function Pd(e){return Array.from(e.data,Nd)}function Fd(e){return!Array.isArray(e)||e.length===0?[1]:e.map(e=>typeof e==`number`&&e>0?e:1)}function Id(e){return e.reduce((e,t)=>e*t,1)}function Ld(e){return 2595*Math.log10(1+e/700)}function Rd(e){return 700*(10**(e/2595)-1)}function zd(e){let t=new Float32Array(e);if(e===1)return t[0]=1,t;for(let n=0;n<e;n+=1)t[n]=.5-.5*Math.cos(2*Math.PI*n/(e-1));return t}function Bd({sampleRate:e,nFft:t,nMels:n,fMin:r,fMax:i}){let a=Math.floor(t/2)+1,o=Array.from({length:n},()=>new Float32Array(a)),s=Ld(r),c=Ld(i),l=new Float32Array(n+2);for(let e=0;e<l.length;e+=1)l[e]=s+(c-s)*e/(n+1);let u=Array.from(l,Rd).map(n=>Math.floor((t+1)*n/e));for(let e=1;e<=n;e+=1){let t=u[e-1],n=u[e],r=u[e+1];for(let r=t;r<n;r+=1)r>=0&&r<a&&n>t&&(o[e-1][r]=(r-t)/(n-t));for(let t=n;t<r;t+=1)t>=0&&t<a&&r>n&&(o[e-1][t]=(r-t)/(r-n))}return o}function Vd(e,t){let n=Math.floor(t/2)+1,r=new Float32Array(n);for(let i=0;i<n;i+=1){let n=0,a=0;for(let r=0;r<t;r+=1){let o=e[r]??0,s=2*Math.PI*i*r/t;n+=o*Math.cos(s),a-=o*Math.sin(s)}r[i]=n*n+a*a}return r}function Hd(e,t={}){let n=t.sampleRate??16e3,r=t.nMels??80,i=t.nFft??512,a=t.winLength??400,o=t.hopLength??160,s=t.fMin??0,c=t.fMax??n/2,l=t.logEps??1e-10,u=t.preemphasis??.97,d=t.normalize??!0;if(u>0){let t=new Float32Array(e.length);e.length>0&&(t[0]=e[0]);for(let n=1;n<e.length;n+=1)t[n]=e[n]-u*e[n-1];e=t}if(e.length<a){let t=new Float32Array(a);t.set(e,0),e=t}let f=1+Math.floor((e.length-a)/o),p=zd(a),m=Bd({sampleRate:n,nFft:i,nMels:r,fMin:s,fMax:c}),h=new Float32Array(r*f),g=new Float32Array(i);for(let t=0;t<f;t+=1){let n=t*o;g.fill(0);for(let t=0;t<a;t+=1)g[t]=e[n+t]*p[t];let s=Vd(g,i);for(let e=0;e<r;e+=1){let n=m[e],r=0;for(let e=0;e<s.length;e+=1)r+=s[e]*n[e];h[e*f+t]=Math.log(Math.max(l,r))}}if(d)for(let e=0;e<r;e+=1){let t=e*f,n=0;for(let e=0;e<f;e+=1)n+=h[t+e];n/=f;let r=0;for(let e=0;e<f;e+=1){let i=h[t+e]-n;r+=i*i}let i=Math.sqrt(r/f)+1e-5;for(let e=0;e<f;e+=1)h[t+e]=(h[t+e]-n)/i}return{features:h,frameCount:f,nMels:r}}var Ud=class{constructor(e){this.session=e,this.inputSignalName=Ad(e,[`input_signal`,`waveforms`],0),this.lengthName=Ad(e,[`length`,`waveforms_lens`],1),this.lengthType=e.inputMetadata.find(e=>e.name===this.lengthName)?.type??`int64`}async run(e){let t=new j(`float32`,e,[1,e.length]),n=jd(this.lengthType,[e.length],[1]),r=await this.session.run({[this.inputSignalName]:t,[this.lengthName]:n});return{signal:Md(this.session,r,0),length:Md(this.session,r,1)}}},Wd=class{constructor(e,t={}){this.session=e,this.options=t,this.audioSignalName=Ad(e,[`audio_signal`,`features`,`waveforms`],0),this.lengthName=Ad(e,[`length`,`features_lens`,`waveforms_lens`],1),this.audioMetadata=e.inputMetadata.find(e=>e.name===this.audioSignalName),this.lengthMetadata=e.inputMetadata.find(e=>e.name===this.lengthName)}prepareInputsFromWaveform(e){let t=this.audioMetadata?.shape?.length??2;if(t===2)return{signal:new j(`float32`,e,[1,e.length]),length:jd(this.lengthMetadata?.type??`int64`,[e.length],[1])};if(t!==3)throw Error(`Unsupported encoder input rank ${t} for '${this.audioSignalName}'.`);let n=this.audioMetadata?.shape?.[1],r=this.options.config?.feature_extraction_params,i=this.options.config?.features_size??r?.n_mels,a=typeof n==`number`&&Number.isFinite(n)?n:i??80,o=this.options.config?.model_type===`gigaam`,s=this.options.sampleRate??r?.sample_rate??16e3,c=Hd(e,{sampleRate:s,nMels:a,nFft:r?.n_fft??512,winLength:r?.window_size?Math.round(Number(r.window_size)*s):400,hopLength:r?.window_stride?Math.round(Number(r.window_stride)*s):160,preemphasis:r?.preemphasis_coefficient??(o?0:.97),normalize:!o});return{signal:new j(`float32`,c.features,[1,c.nMels,c.frameCount]),length:jd(this.lengthMetadata?.type??`int64`,[c.frameCount],[1])}}async run(e,t){let n=await this.session.run({[this.audioSignalName]:e,[this.lengthName]:t}),r=Md(this.session,n,0),i=Md(this.session,n,1);if(r.dims.length===3&&r.dims[0]===1)return{encodedData:r.data,encodedDims:r.dims,encodedLayout:`BCT`,encodedLength:kd(i)};throw Error(`Unexpected encoder output shape: [${r.dims.join(`, `)}]. Expected [1, C, T].`)}},Gd=class extends Wd{constructor(e,t={}){super(e,t),this.vocabSize=t.vocabSize}async run(e,t){let n=await this.session.run({[this.audioSignalName]:e,[this.lengthName]:t}),r=Md(this.session,n,0),i=this.session.outputNames.length>1?n[this.session.outputNames[1]]:null;if(r.dims.length!==3)throw Error(`Unexpected CTC output shape: [${r.dims.join(`, `)}]. Expected rank-3 [1, T, V] or [1, V, T].`);let a,o;if(r.dims[0]===1)a=r.dims[1],o=r.dims[2];else if(r.dims[1]===1)a=r.dims[0],o=r.dims[2];else throw Error(`Unexpected CTC batch layout: [${r.dims.join(`, `)}].`);let s=`BTV`;return this.vocabSize&&a===this.vocabSize&&o!==this.vocabSize?s=`BVT`:this.vocabSize&&o===this.vocabSize&&(s=`BTV`),{encodedData:r.data,encodedDims:[1,a,o],encodedLayout:s,encodedLength:i?kd(i):s===`BVT`?o:a}}},Kd=class{constructor(e,t={}){this.session=e,this.decoderKind=t.decoderKind??`tdt`,this.vocabSize=t.vocabSize,this.encoderOutputsName=Ad(e,[`encoder_outputs`],0),this.targetsName=Ad(e,[`targets`],1),this.targetLengthName=e.inputNames.includes(`target_length`)?`target_length`:null,this.targetsType=e.inputMetadata.find(e=>e.name===this.targetsName)?.type??`int32`,this.targetLengthType=this.targetLengthName?e.inputMetadata.find(e=>e.name===this.targetLengthName)?.type??`int32`:`int32`,this.stateInputNames=e.inputNames.filter(e=>e!==this.encoderOutputsName&&e!==this.targetsName&&e!==this.targetLengthName),this.stateInputMetadata=this.stateInputNames.map(t=>{let n=e.inputMetadata.find(e=>e.name===t);if(!n)throw Error(`Missing input metadata for decoder state '${t}'.`);return n});let n=e.outputNames.filter(e=>/state/i.test(e));this.stateOutputNames=n.length>0?n:e.outputNames.slice(1).filter(e=>!/length/i.test(e))}initialStates(){let e=new Map;for(let t of this.stateInputMetadata){let n=Fd(t.shape),r=Id(n);if(t.type!==`float32`)throw Error(`Unsupported decoder state type '${t.type}' for '${t.name}'.`);e.set(t.name,new j(`float32`,new Float32Array(r),n))}return e}resolveNextStates(e,t){let n=new Map;for(let r=0;r<this.stateInputNames.length;r+=1){let i=this.stateInputNames[r],a=this.stateOutputNames[r];a&&e[a]?n.set(i,e[a]):n.set(i,t.get(i))}return n}argmax(e,t,n){let r=-1/0,i=t;for(let a=t;a<n;a+=1){let t=Nd(e[a]);t>r&&(r=t,i=a)}return i}rnntCandidates(e){if(e.type===`int32`||e.type===`int64`)return Pd(e).map(e=>({token:e,duration:0}));let t=e.data;return[{token:this.argmax(t,0,t.length),duration:0}]}tdtCandidates(e){if(!this.vocabSize||this.vocabSize<=0)throw Error(`TDT decoder requires a positive vocabSize.`);let t=e.data;if(t.length<this.vocabSize)throw Error(`TDT logits length ${t.length} is smaller than vocabSize ${this.vocabSize}.`);let n=this.argmax(t,0,this.vocabSize),r=0;return t.length>this.vocabSize&&(r=this.argmax(t,this.vocabSize,t.length)-this.vocabSize),[{token:n,duration:r}]}async predict(e,t,n,r){let i={[this.encoderOutputsName]:new j(`float32`,e,t),[this.targetsName]:jd(this.targetsType,[n],[1,1])};this.targetLengthName&&(i[this.targetLengthName]=jd(this.targetLengthType,[1],[1]));for(let e of this.stateInputNames){let t=r.get(e);if(!t)throw Error(`Missing decoder state '${e}'.`);i[e]=t}let a=await this.session.run(i),o=Md(this.session,a,0),s=this.resolveNextStates(a,r);return{candidates:this.decoderKind===`rnnt`?this.rnntCandidates(o):this.tdtCandidates(o),nextStates:s}}},qd=class{constructor(e,t={}){this.model=e,this.maxSymbols=t.maxSymbols??10,this.blankTokenId=t.blankTokenId??0,this.defaultDuration=t.defaultDuration??1}frameAt(e,t,n,r){if(n===`BCT`){let n=t[1],i=t[2];if(r>=i)throw Error(`Time index ${r} out of range for encoder output time=${i}.`);let a=new Float32Array(n);for(let t=0;t<n;t+=1)a[t]=Nd(e[t*i+r]);return{data:a,dims:[1,n,1]}}throw Error(`Unsupported encoder layout: ${n}`)}async decode(e,t,n,r){let i=[],a=[],o=this.blankTokenId,s=this.model.initialStates(),c=0,l=n===`BCT`?t[2]:0,u=Math.min(r,l);for(;c<u;){let r=this.frameAt(e,t,n,c),l=c+this.defaultDuration,u=[];for(let e=0;e<this.maxSymbols;e+=1){let{candidates:e,nextStates:t}=await this.model.predict(r.data,r.dims,o,s),n=!1;for(let r of e){let e=Nd(r.token),d=Nd(r.duration);if(e!==this.blankTokenId){let n=i.length;i.push(e),a.push({startFrame:c,endFrame:c+this.defaultDuration}),u.push(n),o=e,s=t}if(d>0){l=c+d,n=!0;break}}if(n)break}for(let e of u)a[e].endFrame=l;c=l}return{tokenIds:i,tokenFrames:a,totalFrames:u}}},Jd=class{constructor(e={}){this.blankTokenId=e.blankTokenId??0}argmaxAt(e,t,n){let r=0,i=-1/0;for(let a=0;a<n;a+=1){let n=Nd(e[t+a]);n>i&&(i=n,r=a)}return r}async decode(e,t,n,r){let i=[],a=[],o=this.blankTokenId,s=n===`BVT`?t[2]:t[1],c=n===`BVT`?t[1]:t[2],l=Math.min(r,s);for(let t=0;t<l;t+=1){let r;if(n===`BVT`){let n=0,i=-1/0;for(let r=0;r<c;r+=1){let a=Nd(e[r*s+t]);a>i&&(i=a,n=r)}r=n}else r=this.argmaxAt(e,t*c,c);if(r===this.blankTokenId){o=this.blankTokenId;continue}if(r===o){let e=a[a.length-1];e&&(e.endFrame=t+1);continue}i.push(r),a.push({startFrame:t,endFrame:t+1}),o=r}return{tokenIds:i,tokenFrames:a,totalFrames:l}}};function Yd(e){return typeof e==`bigint`||typeof e==`string`?Number(e):e}function Xd(e){return 2595*Math.log10(1+e/700)}function Zd(e){return 700*(10**(e/2595)-1)}function Qd(e){let t=new Float32Array(e);if(e===1)return t[0]=1,t;for(let n=0;n<e;n+=1)t[n]=.5-.5*Math.cos(2*Math.PI*n/(e-1));return t}function $d({sampleRate:e,nFft:t,nMels:n,fMin:r,fMax:i}){let a=Math.floor(t/2)+1,o=Array.from({length:n},()=>new Float32Array(a)),s=Xd(r),c=Xd(i),l=new Float32Array(n+2);for(let e=0;e<l.length;e+=1)l[e]=s+(c-s)*e/(n+1);let u=Array.from(l,Zd).map(n=>Math.floor((t+1)*n/e));for(let e=1;e<=n;e+=1){let t=u[e-1],n=u[e],r=u[e+1];for(let r=t;r<n;r+=1)r>=0&&r<a&&n>t&&(o[e-1][r]=(r-t)/(n-t));for(let t=n;t<r;t+=1)t>=0&&t<a&&r>n&&(o[e-1][t]=(r-t)/(r-n))}return o}function ef(e,t){let n=Math.floor(t/2)+1,r=new Float32Array(n);for(let i=0;i<n;i+=1){let n=0,a=0;for(let r=0;r<t;r+=1){let o=e[r]??0,s=2*Math.PI*i*r/t;n+=o*Math.cos(s),a-=o*Math.sin(s)}r[i]=n*n+a*a}return r}function tf(e,t={}){let n=t.sampleRate??16e3,r=t.nMels??80,i=30*n;if(e.length<i){let t=new Float32Array(i);t.set(e,0),e=t}else e.length>i&&(e=e.slice(0,i));let a=new Float32Array(e.length+400);a.set(e,200);let o=1+Math.floor((a.length-400)/160),s=Math.max(1,o-1),c=Qd(400),l=$d({sampleRate:n,nFft:400,nMels:r,fMin:0,fMax:n/2}),u=new Float32Array(r*s),d=new Float32Array(400);for(let e=0;e<s;e+=1){let t=e*160;d.fill(0);for(let e=0;e<400;e+=1)d[e]=a[t+e]*c[e];let n=ef(d,400);for(let t=0;t<r;t+=1){let r=l[t],i=0;for(let e=0;e<n.length;e+=1)i+=n[e]*r[e];u[t*s+e]=Math.max(1e-10,i)}}let f=-1/0;for(let e=0;e<u.length;e+=1){let t=Math.log10(u[e]);u[e]=t,t>f&&(f=t)}let p=f-8;for(let e=0;e<u.length;e+=1)u[e]=(Math.max(u[e],p)+4)/4;return new j(`float32`,u,[1,r,s])}function nf(){let e=[];for(let t=33;t<=126;t+=1)e.push(t);for(let t=161;t<=172;t+=1)e.push(t);for(let t=174;t<=255;t+=1)e.push(t);let t=[...e],n=0;for(let r=0;r<256;r+=1)e.includes(r)||(e.push(r),t.push(256+n),n+=1);let r=t.map(e=>String.fromCharCode(e)),i=new Map;for(let t=0;t<e.length;t+=1)i.set(e[t],r[t]);return i}function rf(e){let t=0,n=-1/0;for(let r=0;r<e.length;r+=1)e[r]>n&&(n=e[r],t=r);return t}function af(e){for(let t of e.values())if(t.data.length>0)return!0;return!1}function of(e,t,n){return e===`int64`?new j(`int64`,BigInt64Array.from(t.map(e=>BigInt(e))),n):new j(`int32`,Int32Array.from(t),n)}function sf(e,t){return new j(`bool`,Uint8Array.from(e.map(e=>+!!e)),t)}function cf(e,t,n){let r=``;for(let n of e){let e=t.get(n);e&&!e.startsWith(`<|`)&&(r+=e)}let i=[];for(let e of r){let t=n.get(e);t!=null&&i.push(t)}return new TextDecoder(`utf-8`,{fatal:!1}).decode(Uint8Array.from(i)).replace(/^ /,``)}var lf=class{constructor({config:e,vocab:t,addedTokens:n}){this.config=e,this.tokens={...t,...n},this.vocabById=new Map;for(let[e,t]of Object.entries(this.tokens))this.vocabById.set(Number(t),e);this.bosTokenId=this.tokens[`<|startoftranscript|>`],this.eosTokenId=this.tokens[`<|endoftext|>`],this.transcribeTokenId=this.tokens[`<|transcribe|>`],this.notimestampsTokenId=this.tokens[`<|notimestamps|>`],this.transcribeInput=[[this.bosTokenId,this.eosTokenId,this.transcribeTokenId,this.notimestampsTokenId]],this.detectLangInput=[[this.bosTokenId]];let r=nf();this.byteDecoder=new Map;for(let[e,t]of r.entries())this.byteDecoder.set(t,e);this.sampleRate=16e3,this.nMels=Number(e.features_size??e.num_mel_bins??80)}_prepareFeatures(e,t){let n=e;return n instanceof Float32Array||(n=Float32Array.from(n)),t!==this.sampleRate&&(n=Ed(n,t,this.sampleRate)),tf(n,{sampleRate:this.sampleRate,nMels:this.nMels})}_decodeTokens(e){return cf(e,this.vocabById,this.byteDecoder)}async _decoding(e,t,n=448){throw Error(`WhisperBaseModel._decoding() must be implemented by subclasses.`)}async _recognizeFeatures(e,t={}){let n=this.transcribeInput.map(e=>e.slice());if(t.language){let e=this.tokens[`<|${t.language}|>`];e!=null&&(n[0][1]=e)}else{let t=await this._decoding(e,this.detectLangInput,3);t.length>0&&t[0].length>1&&(n[0][1]=t[0][1])}let r=(await this._decoding(e,n,t.maxLength??448))[0]??[];return{tokenIds:r,tokenFrames:[],words:[],text:this._decodeTokens(r)}}async transcribeSamples(e,t=this.sampleRate,n={}){let r=this._prepareFeatures(e,t);return this._recognizeFeatures(r,n)}async transcribeWavBuffer(e,t={}){let n=Td(e);return this.transcribeSamples(n.samples,n.sampleRate,t)}},uf=class extends lf{constructor({config:e,vocab:t,addedTokens:n,session:r}){super({config:e,vocab:t,addedTokens:n}),this.session=r,this.inputMetadata=new Map(r.inputMetadata.map(e=>[e.name,e])),this.outputName=r.outputNames.includes(`sequences`)?`sequences`:r.outputNames[0]}_paramTensor(e,t){let n=this.inputMetadata.get(e);return n?n.type===`float`||n.type===`float32`?new j(`float32`,Float32Array.from([t]),[1]):n.type===`int64`?of(`int64`,[t],[1]):of(`int32`,[t],[1]):null}async _decoding(e,t,n=448){let r=Int32Array.from(t.flat()),i={input_features:e,decoder_input_ids:new j(`int32`,r,[t.length,t[0].length])},a={max_length:n,min_length:0,num_beams:1,num_return_sequences:1,length_penalty:1,repetition_penalty:1};for(let[e,t]of Object.entries(a)){let n=this._paramTensor(e,t);n&&(i[e]=n)}let o=(await this.session.run(i))[this.outputName];if(!o)throw Error(`Whisper ORT decoding did not return sequences output.`);let s=Array.from(o.data,Yd),c=o.dims;if(c.length===3){let[e,t,n]=c,r=[];for(let i=0;i<e;i+=1){let e=i*t*n;r.push(s.slice(e,e+n))}return r}if(c.length===2){let[e,t]=c,n=[];for(let r=0;r<e;r+=1)n.push(s.slice(r*t,(r+1)*t));return n}throw Error(`Unexpected whisper-ort sequences shape: [${c.join(`, `)}].`)}},df=class extends lf{constructor({config:e,vocab:t,addedTokens:n,encoderSession:r,decoderSession:i}){super({config:e,vocab:t,addedTokens:n}),this.encoderSession=r,this.decoderSession=i,this.decoderInputMeta=new Map(i.inputMetadata.map(e=>[e.name,e])),this.decoderOutputNames=i.outputNames,this.inputIdName=i.inputNames.includes(`input_ids`)?`input_ids`:i.inputNames[0];let a=i.inputNames.includes(`encoder_hidden_states`)?`encoder_hidden_states`:i.inputNames.find(e=>e.includes(`encoder`));if(!a)throw Error(`Whisper decoder is missing encoder hidden state input.`);this.encoderHiddenName=a,this.useCacheBranchName=i.inputNames.includes(`use_cache_branch`)?`use_cache_branch`:null,this.pastInputNames=i.inputNames.filter(e=>e.startsWith(`past_key_values.`))}_emptyStateTensor(e){let t=(e.shape??[]).map(e=>{if(typeof e==`number`)return e>=0?e:1;if(typeof e==`string`){let t=e.toLowerCase();if(t.includes(`past`)||t.includes(`sequence`))return 0}return 1}),n=t.length===0?0:t.reduce((e,t)=>e*t,1);return new j(`float32`,new Float32Array(n),t)}_createState(){let e=new Map;for(let t of this.pastInputNames){let n=this.decoderInputMeta.get(t);n&&e.set(t,this._emptyStateTensor(n))}return e}_decoderInputTensor(e,t){let n=t?1:e[0].length,r=new Int32Array(e.length*n);for(let i=0;i<e.length;i+=1)t?r[i]=e[i][e[i].length-1]:r.set(e[i],i*n);return(this.decoderInputMeta.get(this.inputIdName)?.type===`int64`?`int64`:`int32`)==`int64`?new j(`int64`,BigInt64Array.from(r,e=>BigInt(e)),[e.length,n]):new j(`int32`,r,[e.length,n])}async _encode(e){let t=this.encoderSession.inputNames[0];return(await this.encoderSession.run({[t]:e}))[this.encoderSession.outputNames[0]]}async _decodeStep(e,t,n){let r=af(t),i={[this.inputIdName]:this._decoderInputTensor(e,r),[this.encoderHiddenName]:n};this.useCacheBranchName&&(i[this.useCacheBranchName]=sf([r],[1]));for(let[e,n]of t.entries())i[e]=n;let a=await this.decoderSession.run(i),o=a[this.decoderOutputNames[0]],s=new Map;for(let e of this.pastInputNames){let n=e.replace(`past_key_values.`,`present.`),r=t.get(e),i=a[n]??r;i&&i.data.length>0?s.set(e,i):r&&s.set(e,r)}return{logits:o,nextState:s}}async _decoding(e,t,n=448){let r=await this._encode(e),i=this._createState(),a=t.map(e=>e.slice());for(let e=a[0].length;e<n;e+=1){let{logits:e,nextState:t}=await this._decodeStep(a,i,r);i=t;let n=e.dims,o=n[n.length-1],s=n[n.length-2],c=n[0];for(let t=0;t<c;t+=1){if(a[t][a[t].length-1]===this.eosTokenId){a[t].push(this.eosTokenId);continue}let n=t*s*o+(s-1)*o,r=rf(Array.from({length:o},(t,r)=>Yd(e.data[n+r]??0)));a[t].push(r)}if(a.every(e=>e[e.length-1]===this.eosTokenId))break}return a}};function ff(e={}){e.numThreads!=null&&(x.wasm.numThreads=e.numThreads),e.wasmPaths&&(x.wasm.wasmPaths=e.wasmPaths),e.simd!=null&&(x.wasm.simd=e.simd),e.proxy!=null&&(x.wasm.proxy=e.proxy)}function pf(e){let t=e.split(/\r?\n/).map(e=>e.trim()).filter(Boolean);if(t.every(e=>/^(.*)\s+(\d+)$/.test(e))){let e=t.map(e=>{let t=e.match(/^(.*)\s+(\d+)$/);if(!t)throw Error(`Invalid indexed vocabulary line: ${e}`);return{token:t[1],id:Number(t[2])}}),n=e.reduce((e,t)=>Math.max(e,t.id),0),r=Array(n+1);for(let t of e)r[t.id]=t.token;return r}return t}function mf(e){return!!(e&&e.startsWith(`<`)&&e.endsWith(`>`))}function hf(e){return e.split(`▁`).join(` `)}function gf(e){return typeof e==`bigint`||typeof e==`string`?Number(e):e}function _f(e){return e instanceof Float32Array?Float32Array.from(e):Float32Array.from(Array.from(e,gf))}function vf(e,t){return t.map(t=>e[t]).filter(e=>e&&!mf(e)).map(e=>hf(e)).join(``).trim()}function yf(e,t,n,r){let i=[],a=null,o=()=>{if(!a)return;let e=a.text.trim();e&&i.push({word:e,start:Number((a.startFrame*r).toFixed(3)),end:Number((a.endFrame*r).toFixed(3))}),a=null};for(let r=0;r<t.length;r+=1){let i=e[t[r]],s=n[r];if(!i||!s||mf(i))continue;let c=i.startsWith(`▁`),l=hf(i);if(c){o(),a={text:l.trimStart(),startFrame:s.startFrame,endFrame:s.endFrame};continue}a?(a.text+=l,a.endFrame=s.endFrame):a={text:l,startFrame:s.startFrame,endFrame:s.endFrame}}return o(),i}function bf(e){for(let t of[`<blk>`,`<blank>`]){let n=e.findIndex(e=>e===t);if(n>=0)return n}return e.length-1}var xf=class{constructor({preprocessor:e=null,encoder:t,decoder:n,tokens:r,sampleRate:i=16e3}){this.preprocessor=e,this.encoder=t,this.decoder=n,this.tokens=r,this.sampleRate=i}async transcribeSamples(e,t=this.sampleRate){let n=e;n instanceof Float32Array||(n=Float32Array.from(n)),t!==this.sampleRate&&(n=Ed(n,t,this.sampleRate)),this.preprocessor&&(n=Dd(n));let r=this.preprocessor?await this.preprocessor.run(n):this.encoder.prepareInputsFromWaveform(n),i=await this.encoder.run(r.signal,r.length),a=await this.decoder.decode(i.encodedData,i.encodedDims,i.encodedLayout,i.encodedLength),o=a.tokenIds,s=a.tokenFrames,c=i.encodedLength>0?n.length/this.sampleRate/i.encodedLength:0;return{tokenIds:o,tokenFrames:s,words:yf(this.tokens,o,s,c),text:vf(this.tokens,o)}}async transcribeWavBuffer(e){let t=Td(e);return this.transcribeSamples(t.samples,t.sampleRate)}};function Sf(e,t,n){return e===`int64`?new j(`int64`,BigInt64Array.from(t.map(e=>BigInt(e))),n):new j(`int32`,Int32Array.from(t),n)}function Cf(e,t){let n=t.reduce((e,t)=>e*t,1);if(e===`float32`)return new j(`float32`,new Float32Array(n),t);if(e===`float16`)return new j(`float16`,new Uint16Array(n),t);throw Error(`Unsupported tensor init type '${e}'.`)}function wf(e,t,n){let r=0,i=-1/0;for(let a=0;a<n;a+=1){let n=gf(e[t+a]);n>i&&(i=n,r=a)}return r}function Tf(e,t,n=0){for(let n of t)if(e.includes(n))return n;return e[n]}function Ef(e,t){return e.inputMetadata.find(e=>e.name===t)??e.outputMetadata.find(e=>e.name===t)??null}function Df(e,t={}){let n=t.batch??1;return(e?.shape??[]).map((e,t)=>typeof e==`number`?e>=0?e:1:t===0||String(e).toLowerCase().includes(`batch`)?n:(String(e).toLowerCase().includes(`time`),1))}var Of=class{constructor({config:e,tokens:t,encoderSession:n,decoderSession:r}){this.config=e,this.tokens=t,this.tokenToId=new Map;for(let e=0;e<t.length;e+=1){let n=t[e];n!=null&&!this.tokenToId.has(n)&&this.tokenToId.set(n,e)}this.encoderSession=n,this.decoderSession=r,this.encoderHelper=new Wd(n,{config:e,sampleRate:16e3}),this.sampleRate=16e3,this.maxSequenceLength=e?.max_sequence_length??1024,this.encoderOutputEmbeddingsName=n.outputNames.includes(`encoder_embeddings`)?`encoder_embeddings`:n.outputNames[0],this.encoderOutputMaskName=n.outputNames.includes(`encoder_mask`)?`encoder_mask`:n.outputNames[1],this.decoderInputIdName=r.inputNames.includes(`input_ids`)?`input_ids`:r.inputNames[0],this.decoderEncoderEmbeddingsName=r.inputNames.includes(`encoder_embeddings`)?`encoder_embeddings`:r.inputNames[1],this.decoderEncoderMaskName=r.inputNames.includes(`encoder_mask`)?`encoder_mask`:r.inputNames[2],this.decoderMemsName=r.inputNames.includes(`decoder_mems`)?`decoder_mems`:r.inputNames[3];let i=r.inputMetadata.find(e=>e.name===this.decoderInputIdName);this.decoderInputIdType=i?.type??`int32`;let a=r.inputMetadata.find(e=>e.name===this.decoderMemsName);if(!a)throw Error(`Decoder input metadata for decoder_mems is missing.`);this.decoderMemsType=a.type??`float32`,this.decoderMemsShapeTemplate=a.shape??[1,1,0,1],this.logitsName=r.outputNames.includes(`logits`)?`logits`:r.outputNames[0],this.decoderHiddenStatesName=r.outputNames.includes(`decoder_hidden_states`)?`decoder_hidden_states`:r.outputNames[1]}canaryPrefix(e={}){let t=e.language??`en`,n=e.targetLanguage??`en`,r=e.pnc??`yes`;return[`<|startofcontext|>`,`<|startoftranscript|>`,`<|emo:undefined|>`,`<|${t}|>`,`<|${n}|>`,r===`yes`?`<|pnc|>`:`<|nopnc|>`,`<|noitn|>`,`<|notimestamp|>`,`<|nodiarize|>`].map(e=>{let t=this.tokenToId.get(e);if(t==null)throw Error(`Required Canary token not found in vocab: ${e}`);return t})}initialMems(e){let t=this.decoderMemsShapeTemplate.map((t,n)=>typeof t==`number`?t:n===1?e:n===2?0:1);return Cf(this.decoderMemsType,t)}async transcribeSamples(e,t=this.sampleRate,n={}){let r=e;r instanceof Float32Array||(r=Float32Array.from(r)),t!==this.sampleRate&&(r=Ed(r,t,this.sampleRate));let i=this.encoderHelper.prepareInputsFromWaveform(r),a=await this.encoderSession.run({[this.encoderHelper.audioSignalName]:i.signal,[this.encoderHelper.lengthName]:i.length}),o=a[this.encoderOutputEmbeddingsName],s=a[this.encoderOutputMaskName];if(!o||!s)throw Error(`Canary encoder outputs are missing required tensors.`);let c=[this.canaryPrefix(n).slice()],l=c[0].length,u=this.tokenToId.get(`<|endoftext|>`);if(u==null)throw Error(`Canary vocab is missing <|endoftext|> token.`);let d=this.initialMems(c.length);for(;c[0].length<this.maxSequenceLength;){let e=d.dims[2]===0?c.flat():c.map(e=>e[e.length-1]),t=d.dims[2]===0?c[0].length:1,n=Sf(this.decoderInputIdType,e,[c.length,t]),r=await this.decoderSession.run({[this.decoderInputIdName]:n,[this.decoderEncoderEmbeddingsName]:o,[this.decoderEncoderMaskName]:s,[this.decoderMemsName]:d}),i=r[this.logitsName],a=r[this.decoderHiddenStatesName];if(!i||!a)throw Error(`Canary decoder outputs are missing logits or decoder state.`);d=a;let[l,f,p]=i.dims,m=!0;for(let e=0;e<l;e+=1){let t=e*f*p+(f-1)*p,n=wf(i.data,t,p);c[e].push(n),n!==u&&(m=!1)}if(m)break}let f=c[0].slice(l).filter(e=>this.tokens[e]&&!this.tokens[e].startsWith(`<|`));return{tokenIds:f,tokenFrames:[],words:[],text:vf(this.tokens,f)}}async transcribeWavBuffer(e,t={}){let n=Td(e);return this.transcribeSamples(n.samples,n.sampleRate,t)}},kf=class{constructor({config:e,tokens:t,encoderSession:n,decoderSession:r,jointSession:i}){this.config=e,this.tokens=t,this.encoderSession=n,this.decoderSession=r,this.jointSession=i,this.sampleRate=16e3,this.encoderHelper=new Wd(n,{config:e,sampleRate:this.sampleRate}),this.blankTokenId=bf(t),this.maxTokensPerStep=e?.max_tokens_per_step??3,this.decoderTargetName=Tf(r.inputNames,[`targets`,`target`,`tokens`],0),this.decoderTargetLengthName=r.inputNames.includes(`target_length`)?`target_length`:null,this.decoderTargetType=Ef(r,this.decoderTargetName)?.type??`int32`,this.decoderTargetLengthType=this.decoderTargetLengthName?Ef(r,this.decoderTargetLengthName)?.type??`int32`:`int32`,this.decoderStateInputNames=r.inputNames.filter(e=>e!==this.decoderTargetName&&e!==this.decoderTargetLengthName),this.decoderVectorOutputName=r.outputNames.find(e=>/dec|pred|output/i.test(e))??r.outputNames[0],this.decoderStateOutputNames=r.outputNames.filter(e=>e!==this.decoderVectorOutputName&&!/length/i.test(e)),this.jointEncoderInputName=Tf(i.inputNames,[`encoder_outputs`,`encoder_output`,`enc_out`,`encoder`],0),this.jointDecoderInputName=i.inputNames.find(e=>e!==this.jointEncoderInputName)??i.inputNames[1],this.jointOutputName=i.outputNames[0],this.jointEncoderShape=Ef(i,this.jointEncoderInputName)?.shape??[1,1,1],this.jointDecoderShape=Ef(i,this.jointDecoderInputName)?.shape??[1,1,1]}initialDecoderStates(e=1){let t=new Map;for(let n of this.decoderStateInputNames){let r=Ef(this.decoderSession,n);if(!r||r.type!==`float32`)continue;let i=Df(r,{batch:e});t.set(n,Cf(`float32`,i))}return t}adaptJointInput(e,t){if(!Array.isArray(t)||t.length!==3||e.dims.length!==3)return e;let n=typeof t[1]==`number`?t[1]:e.dims[1],r=typeof t[2]==`number`?t[2]:e.dims[2];if(e.dims[1]===n&&e.dims[2]===r)return e;if(e.dims[1]===r&&e.dims[2]===n){let[t,n,r]=e.dims,i=new Float32Array(t*r*n);for(let a=0;a<t;a+=1)for(let t=0;t<n;t+=1)for(let o=0;o<r;o+=1){let s=a*n*r+t*r+o,c=a*r*n+o*n+t;i[c]=gf(e.data[s])}return new j(`float32`,i,[t,r,n])}return e}runJointArgmax(e,t){let n=this.adaptJointInput(e,this.jointEncoderShape),r=this.adaptJointInput(t,this.jointDecoderShape);return this.jointSession.run({[this.jointEncoderInputName]:n,[this.jointDecoderInputName]:r}).then(e=>{let t=e[this.jointOutputName];if(!t)throw Error(`GigaAM RNNT joint output tensor is missing.`);return wf(t.data,0,t.data.length)})}async transcribeSamples(e,t=this.sampleRate){let n=e;n instanceof Float32Array||(n=Float32Array.from(n)),t!==this.sampleRate&&(n=Ed(n,t,this.sampleRate));let r=this.encoderHelper.prepareInputsFromWaveform(n),i=await this.encoderHelper.run(r.signal,r.length),[a,o,s]=i.encodedDims;if(a!==1)throw Error(`GigaAM RNNT currently expects batch=1, got ${a}.`);let c=i.encodedLength>0?n.length/this.sampleRate/i.encodedLength:0,l=this.initialDecoderStates(1),u=this.blankTokenId,d=[],f=[],p=Math.min(i.encodedLength,s);for(let e=0;e<p;e+=1){let t=new Float32Array(o);for(let n=0;n<o;n+=1)t[n]=gf(i.encodedData[n*s+e]);let n=new j(`float32`,t,[1,o,1]);for(let t=0;t<this.maxTokensPerStep;t+=1){let t={[this.decoderTargetName]:Sf(this.decoderTargetType,[u],[1,1])};this.decoderTargetLengthName&&(t[this.decoderTargetLengthName]=Sf(this.decoderTargetLengthType,[1],[1]));for(let[e,n]of l.entries())t[e]=n;let r=await this.decoderSession.run(t),i=r[this.decoderVectorOutputName];if(!i)throw Error(`GigaAM RNNT decoder vector output is missing.`);let a=new Map(l);for(let e of this.decoderStateInputNames){let t=r[e];if(t){a.set(e,t);continue}let n=e.replace(/\.\d+$/,``),i=this.decoderStateOutputNames.find(t=>t===e||t.replace(/\.\d+$/,``)===n);i&&r[i]&&a.set(e,r[i])}let o=await this.runJointArgmax(n,i);if(o===this.blankTokenId)break;d.push(o),f.push({startFrame:e,endFrame:e+1}),u=o,l=a}}return{tokenIds:d,tokenFrames:f,words:yf(this.tokens,d,f,c),text:vf(this.tokens,d)}}async transcribeWavBuffer(e){let t=Td(e);return this.transcribeSamples(t.samples,t.sampleRate)}},Af=class{constructor({config:e,tokens:t,session:n}){this.config=e,this.tokens=t,this.session=n,this.sampleRate=Number(e?.feature_extraction_params?.sample_rate)||Number(e?.sample_rate)||8e3,this.blankTokenId=typeof e?.pad_token_id==`number`?e.pad_token_id:bf(t),this.signalName=n.inputNames[0],this.stateName=n.inputNames[1],this.logitsName=n.outputNames[0],this.nextStateName=n.outputNames[1],this.signalMeta=Ef(n,this.signalName),this.stateMeta=Ef(n,this.stateName),this.chunkSamples=typeof this.signalMeta?.shape?.[1]==`number`?this.signalMeta.shape[1]:2400,this.stateType=this.stateMeta?.type??`float16`,this.stateShape=Df(this.stateMeta,{batch:1})}toIntPcm(e){let t=new Int32Array(e.length);for(let n=0;n<e.length;n+=1){let r=Math.max(-1,Math.min(1,e[n]));t[n]=Math.round(r*32767)}return t}decodeCtcGreedy(e,t,n,r){let i=this.blankTokenId;for(let a=0;a<n.length;a+=1){let o=n[a],s=r+a;if(o===this.blankTokenId){i=this.blankTokenId;continue}if(o===i){let e=t[t.length-1];e&&(e.endFrame=s+1);continue}e.push(o),t.push({startFrame:s,endFrame:s+1}),i=o}}async transcribeSamples(e,t=this.sampleRate){let n=e;n instanceof Float32Array||(n=Float32Array.from(n)),t!==this.sampleRate&&(n=Ed(n,t,this.sampleRate));let r=this.toIntPcm(n),i=Cf(this.stateType,this.stateShape),a=[],o=[],s=0,c=0;for(;c<r.length;){let e=Math.min(c+this.chunkSamples,r.length),t=new Int32Array(this.chunkSamples);t.set(r.subarray(c,e),0);let n=new j(`int32`,t,[1,this.chunkSamples,1]),l=await this.session.run({[this.signalName]:n,[this.stateName]:i}),u=l[this.logitsName],d=l[this.nextStateName];if(!u||!d)throw Error(`Tone CTC model outputs are missing logprobs or state_next.`);i=d;let[f,p,m]=u.dims;if(f!==1)throw Error(`Tone CTC currently expects batch=1, got ${f}.`);let h=[];for(let e=0;e<p;e+=1){let t=e*m;h.push(wf(u.data,t,m))}this.decodeCtcGreedy(a,o,h,s),s+=p,c=e}let l=s>0?n.length/this.sampleRate/s:0;return{tokenIds:a,tokenFrames:o,words:yf(this.tokens,a,o,l),text:vf(this.tokens,a)}}async transcribeWavBuffer(e){let t=Td(e);return this.transcribeSamples(t.samples,t.sampleRate)}},jf=class{constructor({config:e,tokens:t,encoderSession:n,decoderSession:r,joinerSession:i}){this.config=e??{},this.tokens=t,this.encoderSession=n,this.decoderSession=r,this.joinerSession=i,this.sampleRate=Number(this.config.sample_rate)||16e3,this.blankTokenId=bf(t),this.maxSymbolsPerFrame=this.config.max_tokens_per_step??10,this.encoderInputName=n.inputNames[0],this.encoderLengthName=n.inputNames.length>1?n.inputNames[1]:null,this.encoderInputMeta=Ef(n,this.encoderInputName),this.encoderLengthMeta=this.encoderLengthName?Ef(n,this.encoderLengthName):null,this.encoderOutputName=n.outputNames[0],this.encoderLengthOutName=n.outputNames.length>1?n.outputNames[1]:null,this.decoderInputName=r.inputNames[0],this.decoderInputMeta=Ef(r,this.decoderInputName),this.decoderOutputName=r.outputNames[0];let a=this.decoderInputMeta?.shape?.[1];this.contextSize=typeof a==`number`&&a>0?a:1,this.decoderInputType=this.decoderInputMeta?.type??`int64`,this.joinerEncName=i.inputNames[0],this.joinerDecName=i.inputNames[1],this.joinerOutputName=i.outputNames[0],this.joinerEncShape=Ef(i,this.joinerEncName)?.shape??[1,1,1],this.joinerDecShape=Ef(i,this.joinerDecName)?.shape??[1,1,1],this.encoderFeatureConfig={model_type:`sherpa-transducer`,features_size:Number(this.encoderInputMeta?.shape?.[1])||80,feature_extraction_params:{sample_rate:this.sampleRate,n_mels:Number(this.encoderInputMeta?.shape?.[1])||80,n_fft:400,window_size:.025,window_stride:.01,preemphasis_coefficient:.97}},this.encoderHelper=new Wd(n,{config:this.encoderFeatureConfig,sampleRate:this.sampleRate})}adaptTensorToShape(e,t){if(!Array.isArray(t))return e;if(t.length!==e.dims.length){if(e.dims.length===3&&t.length===2&&e.dims[0]===1){let t=_f(e.data);if(e.dims[1]===1)return new j(`float32`,t,[1,e.dims[2]]);if(e.dims[2]===1)return new j(`float32`,t,[1,e.dims[1]])}if(e.dims.length===2&&t.length===3&&e.dims[0]===1){let n=e.dims[1];return t[1]===1||t[2]===n?new j(`float32`,_f(e.data),[1,1,n]):new j(`float32`,_f(e.data),[1,n,1])}return e}if(e.dims.every((e,n)=>typeof t[n]!=`number`||t[n]<0||e===t[n]))return e;if(e.dims.length===3&&e.dims[1]===t[2]&&e.dims[2]===t[1]){let[t,n,r]=e.dims,i=new Float32Array(t*r*n);for(let a=0;a<t;a+=1)for(let t=0;t<n;t+=1)for(let o=0;o<r;o+=1)i[a*r*n+o*n+t]=gf(e.data[a*n*r+t*r+o]);return new j(`float32`,i,[t,r,n])}return e}makeDecoderInput(e){return Sf(this.decoderInputType,e,[1,this.contextSize])}async runEncoder(e){if((this.encoderInputMeta?.shape?.length??2)===2){let t=new j(`float32`,e,[1,e.length]),n=Sf(this.encoderLengthMeta?.type??`int64`,[e.length],[1]);return await this.encoderSession.run({[this.encoderInputName]:t,...this.encoderLengthName?{[this.encoderLengthName]:n}:{}})}let t=this.encoderHelper.prepareInputsFromWaveform(e),n=t.signal,r=this.encoderInputMeta?.shape??[];if(n.dims.length===3&&r.length===3){let e=n.dims[1],t=r[1],i=r[2];if(typeof i==`number`&&i===e&&t!==e){let t=n.dims[2],r=new Float32Array(t*e);for(let i=0;i<e;i+=1)for(let a=0;a<t;a+=1)r[a*e+i]=gf(n.data[i*t+a]);n=new j(`float32`,r,[1,t,e])}}return await this.encoderSession.run({[this.encoderInputName]:n,...this.encoderLengthName?{[this.encoderLengthName]:t.length}:{}})}async transcribeSamples(e,t=this.sampleRate){let n=e;n instanceof Float32Array||(n=Float32Array.from(n)),t!==this.sampleRate&&(n=Ed(n,t,this.sampleRate));let r=await this.runEncoder(n),i=r[this.encoderOutputName],a=this.encoderLengthOutName?r[this.encoderLengthOutName]:null;if(!i)throw Error(`Sherpa encoder output is missing.`);let o,s,c;if(i.dims.length!==3)throw Error(`Unexpected Sherpa encoder output shape: [${i.dims.join(`, `)}].`);if(i.dims[0]!==1)throw Error(`Sherpa transducer currently expects batch=1, got ${i.dims[0]}.`);if(typeof this.joinerEncShape?.[1]==`number`&&i.dims[1]===this.joinerEncShape[1])o=i.dims[1],s=i.dims[2],c=i.data;else{s=i.dims[1],o=i.dims[2],c=new Float32Array(o*s);for(let e=0;e<s;e+=1)for(let t=0;t<o;t+=1)c[t*s+e]=gf(i.data[e*o+t])}let l=a?gf(Array.from(a.data,gf)[0]??s):s,u=Math.min(s,l),d=[],f=[],p=Array(this.contextSize).fill(this.blankTokenId);for(let e=0;e<u;e+=1){let t=new Float32Array(o);for(let n=0;n<o;n+=1)t[n]=gf(c[n*s+e]);let n=new j(`float32`,t,[1,o,1]);n=this.adaptTensorToShape(n,this.joinerEncShape);for(let t=0;t<this.maxSymbolsPerFrame;t+=1){let t=(await this.decoderSession.run({[this.decoderInputName]:this.makeDecoderInput(p)}))[this.decoderOutputName];if(!t)throw Error(`Sherpa decoder output is missing.`);t=this.adaptTensorToShape(t,this.joinerDecShape);let r=(await this.joinerSession.run({[this.joinerEncName]:n,[this.joinerDecName]:t}))[this.joinerOutputName];if(!r)throw Error(`Sherpa joiner output is missing.`);let i=wf(r.data,0,r.data.length);if(i===this.blankTokenId)break;d.push(i),f.push({startFrame:e,endFrame:e+1}),p.shift(),p.push(i)}}let m=u>0?n.length/this.sampleRate/u:0;return{tokenIds:d,tokenFrames:f,words:yf(this.tokens,d,f,m),text:vf(this.tokens,d)}}async transcribeWavBuffer(e){let t=Td(e);return this.transcribeSamples(t.samples,t.sampleRate)}};async function Mf({modelType:e,decoderKind:t,config:n,preprocessorModel:r,encoderModel:i,decoderModel:a,decoderJointModel:o,whisperModel:s,vocabularyText:c,vocabJson:l,addedTokensJson:u,sessionOptions:d,decoderOptions:f}={}){if(!e||!t)throw Error(`createAsrModel expects modelType and decoderKind.`);let p=Number(n?.feature_extraction_params?.sample_rate)||Number(n?.sample_rate)||16e3;if(t===`whisper-ort`){if(!s||!l)throw Error(`whisper-ort requires whisperModel and vocabJson.`);let e=await N.create(s,d);return new uf({config:n??{},vocab:JSON.parse(l),addedTokens:u?JSON.parse(u):{},session:e})}if(t===`whisper-hf`){if(!i||!o||!l)throw Error(`whisper requires encoderModel, decoderJointModel, and vocabJson.`);let[e,t]=await Promise.all([N.create(i,d),N.create(o,d)]);return new df({config:n??{},vocab:JSON.parse(l),addedTokens:u?JSON.parse(u):{},encoderSession:e,decoderSession:t})}if(t===`aed`){if(!i||!o||!c)throw Error(`nemo-conformer-aed requires encoderModel, decoderModel, and vocabularyText.`);let[e,t]=await Promise.all([N.create(i,d),N.create(o,d)]);return new Of({config:n,tokens:pf(c),encoderSession:e,decoderSession:t})}if(t===`gigaam-rnnt`){if(!i||!a||!o||!c)throw Error(`gigaam rnnt requires encoderModel, decoderModel, jointModel, and vocabularyText.`);let[e,t,r]=await Promise.all([N.create(i,d),N.create(a,d),N.create(o,d)]);return new kf({config:n,tokens:pf(c),encoderSession:e,decoderSession:t,jointSession:r})}if(t===`tone-ctc`){if(!i||!c)throw Error(`tone-ctc requires model.onnx and vocabulary.`);let e=await N.create(i,d);return new Af({config:n,tokens:pf(c),session:e})}if(t===`sherpa-transducer`){if(!i||!a||!o||!c)throw Error(`sherpa-transducer requires encoder, decoder, joiner, and tokens.`);let[e,t,r]=await Promise.all([N.create(i,d),N.create(a,d),N.create(o,d)]);return new jf({config:n,tokens:pf(c),encoderSession:e,decoderSession:t,joinerSession:r})}if(!i||!c)throw Error(`createAsrModel expects encoderModel and vocabularyText for non-whisper models.`);if(t!==`ctc`&&!o)throw Error(`Transducer models require decoderJointModel.`);let m=[N.create(i,d)];o&&m.push(N.create(o,d)),r&&m.unshift(N.create(r,d));let h=await Promise.all(m),g=r?h[0]:null,_=r?h[1]:h[0],v=r?h[2]:h[1],y=pf(c),b=bf(y),x=n?.max_tokens_per_step??f?.maxSymbols??10;if(t===`ctc`){let e=typeof n?.pad_token_id==`number`?n.pad_token_id:bf(y);return new xf({preprocessor:g?new Ud(g):null,encoder:new Gd(_,{config:n,sampleRate:p,vocabSize:y.length}),decoder:new Jd({blankTokenId:e}),tokens:y,sampleRate:p})}return new xf({preprocessor:g?new Ud(g):null,encoder:new Wd(_,{config:n,sampleRate:p}),decoder:new qd(new Kd(v,{decoderKind:t===`rnnt`?`rnnt`:`tdt`,vocabSize:y.length}),{blankTokenId:b,maxSymbols:x,...f}),tokens:y,sampleRate:p})}var Nf={"nemo-conformer-tdt":{decoderKind:`tdt`,preprocessor:`nemo128.onnx`,encoder:`encoder-model.onnx`,decoderJoint:`decoder_joint-model.onnx`,vocabCandidates:[`tokens.txt`,`vocab.txt`]},"nemo-conformer-rnnt":{decoderKind:`rnnt`,preprocessor:null,encoder:`encoder-model.onnx`,decoderJoint:`decoder_joint-model.onnx`,vocabCandidates:[`vocab.txt`,`tokens.txt`]},"nemo-conformer-ctc":{decoderKind:`ctc`,preprocessor:null,encoder:`model.onnx`,decoderJoint:null,vocabCandidates:[`vocab.txt`,`tokens.txt`]},"nemo-conformer-aed":{decoderKind:`aed`,preprocessor:null,encoder:`encoder-model.onnx`,decoderJoint:`decoder-model.onnx`,vocabCandidates:[`vocab.txt`,`tokens.txt`]},"nemo-conformer":{decoderKind:`nemo-conformer`,preprocessor:null,encoder:`encoder-model.onnx`,decoderJoint:`decoder_joint-model.onnx`,vocabCandidates:[`vocab.txt`,`tokens.txt`]},gigaam:{decoderKind:`gigaam`,preprocessor:null,encoder:null,decoderJoint:null,vocabCandidates:[`v3_vocab.txt`,`v2_vocab.txt`,`vocab.txt`,`tokens.txt`]},"whisper-ort":{decoderKind:`whisper-ort`,preprocessor:null,encoder:null,decoderJoint:null,vocabCandidates:[],whisperModelPattern:/_beamsearch(?:\\.int8)?\\.onnx$/},whisper:{decoderKind:`whisper-hf`,preprocessor:null,encoder:`onnx/encoder_model.onnx`,decoderJoint:`onnx/decoder_model_merged.onnx`,vocabCandidates:[]},"tone-ctc":{decoderKind:`tone-ctc`,preprocessor:null,encoder:`model.onnx`,decoderJoint:null,vocabCandidates:[`vocab.txt`,`tokens.txt`,`vocab.json`]}};function Pf(e){let t;try{t=JSON.parse(e)}catch(e){throw Error(`Invalid config.json: ${e}`)}if(!t||typeof t!=`object`)throw Error(`Invalid config.json: expected a JSON object.`);return t}function Ff(e){let t=e?.model_type;if(!t||typeof t!=`string`){if((Array.isArray(e?.architectures)?e.architectures:[]).includes(`ToneForCTC`))return{modelType:`tone-ctc`,spec:Nf[`tone-ctc`]};throw Error(`config.json is missing string field 'model_type'.`)}let n=Nf[t];if(!n)throw Error(`Unsupported model_type: ${t}`);return{modelType:t,spec:n}}function If(e){let t=e?.decoder_params?.vocabulary;if(!Array.isArray(t)||t.length===0)return null;let n=t.map((e,t)=>`${e===` `?`▁`:e} ${t}`),r=e?.pad_token_id;return typeof r==`number`&&r>=t.length&&n.push(`<blank> ${r}`),`${n.join(`
`)}
`}function Lf(e){return e.filter(e=>typeof e==`string`&&e.trim().length>0).join(` `).replace(/\s+/g,` `).trim()}function Rf(e){return e instanceof Float32Array?e:Float32Array.from(e)}var zf=class{constructor(e,t,n={}){this.baseModel=e,this.vadModel=t,this.options=n,this.sampleRate=e.sampleRate??t.sampleRate??16e3}async transcribeSamples(e,t=this.sampleRate,n={}){let r=Rf(e),i=n.vadOptions??this.options,a=await this.vadModel.detectSpeechSegments(r,t,i);if(a.length===0)return{tokenIds:[],tokenFrames:[],words:[],text:``,segments:[]};let o=[],s=[],c=[];for(let e of a){let i=r.subarray(e.start,e.end),a=await this.baseModel.transcribeSamples(i,t,n);o.push(...a.tokenIds??[]),a.text&&c.push(a.text);for(let t of a.words??[])s.push({word:t.word,start:Number((t.start+e.startSec).toFixed(3)),end:Number((t.end+e.startSec).toFixed(3))})}return{tokenIds:o,tokenFrames:[],words:s,text:Lf(c),segments:a}}async transcribeWavBuffer(e,t={}){let n=Td(e);return this.transcribeSamples(n.samples,n.sampleRate,t)}};function Bf(e,t,n={}){if(!t||typeof t.detectSpeechSegments!=`function`)throw Error(`Invalid VAD model: expected detectSpeechSegments(samples, sampleRate, options).`);return new zf(e,t,n)}function Vf(e,t){if(!e)throw Error(t);return e}function Hf(e,t=`int8`){if(!e.endsWith(`.onnx`)||t!==`int8`)return[e];let n=e.replace(/\.onnx$/,`.int8.onnx`),r=e.replace(/\.onnx$/,`_int8.onnx`);return[...new Set([n,r,e])]}function Uf(e,t){let n=e.endsWith(`/`)?e:`${e}/`,r=typeof globalThis.location?.href==`string`?globalThis.location.href:`http://localhost/`,i=new URL(n,r);return new URL(t,i).toString()}async function Wf(e,t,n){let r=await t(e,{headers:n});if(!r.ok)throw Error(`Failed to fetch ${e}: ${r.status} ${r.statusText}`);return r.text()}async function Gf(e,t,n){let r=await t(e,{headers:n});if(r.status===404)return null;if(!r.ok)throw Error(`Failed to fetch ${e}: ${r.status} ${r.statusText}`);return r.text()}async function Kf(e,t,n){let r=await t(e,{method:`HEAD`,headers:n});if(r.ok)return!0;if(r.status===404)return!1;let i=await t(e,{headers:n});if(i.ok)return!0;if(i.status===404)return!1;throw Error(`Failed to probe ${e}: ${i.status} ${i.statusText}`)}async function qf(e,t,n){let{fetchImpl:r,headers:i,quantization:a}=n,o=Hf(t,a);for(let t of o){let n=Uf(e,t);if(await Kf(n,r,i))return n}return Uf(e,o[o.length-1])}async function Jf(e,t,n,r){for(let i of t){let t=Uf(e,i);if(await Kf(t,n,r))return t}throw Error(`Missing file. Checked: ${t.join(`, `)}`)}async function Yf(e,t,n,r){return Wf(await Jf(e,t,n,r),n,r)}function Xf(e){let t=JSON.parse(e),n=Object.entries(t).filter(([,e])=>Number.isInteger(e)).sort((e,t)=>Number(e[1])-Number(t[1]));if(n.length===0)throw Error(`Invalid vocab.json mapping.`);return`${n.map(([e,t])=>`${e} ${t}`).join(`
`)}
`}async function Zf(e,t,n,r,i){let a=await r(`${n.replace(/\/$/,``)}/api/models/${e}/tree/${encodeURIComponent(t)}?recursive=1`,{headers:i});if(!a.ok)throw Error(`Failed to list Hugging Face repo files: ${a.status} ${a.statusText}`);let o=await a.json();return new Set(o.map(e=>e.path).filter(e=>typeof e==`string`))}function Qf(e,t){let n=[...e].filter(e=>/_beamsearch(?:\.int8)?\.onnx$/.test(e));if(n.length===0)return null;if(t===`int8`){let e=n.find(e=>/(?:\.int8|_int8)\.onnx$/.test(e));if(e)return e}return n.find(e=>!/(?:\.int8|_int8)\.onnx$/.test(e))??n[0]}async function $f(e,t,n,r,i){let a=t.version??`v2`,o=await Yf(e,[`${a}_vocab.txt`,`vocab.txt`,`tokens.txt`],r,i),s=[`${a}_rnnt`,`${a}_e2e_rnnt`];for(let t of s){let a=await Jf(e,Hf(`${t}_encoder.onnx`,n),r,i).catch(()=>null),s=await Jf(e,Hf(`${t}_decoder.onnx`,n),r,i).catch(()=>null),c=await Jf(e,Hf(`${t}_joint.onnx`,n),r,i).catch(()=>null);if(a&&s&&c)return{mode:`rnnt`,encoder:a,decoder:s,joint:c,vocabularyText:o}}let c=[`${a}_ctc.onnx`,`${a}_e2e_ctc.onnx`];for(let t of c){let a=await Jf(e,Hf(t,n),r,i).catch(()=>null);if(a)return{mode:`ctc`,ctcModel:a,vocabularyText:o}}throw Error(`Could not resolve GigaAM RNNT or CTC model files.`)}async function ep(e,t,n,r){let i=await Jf(e,Hf(`encoder-model.onnx`,t),n,r).catch(()=>null),a=await Jf(e,Hf(`decoder_joint-model.onnx`,t),n,r).catch(()=>null);if(i&&a)return{mode:`rnnt`,encoder:i,decoderJoint:a};let o=await Jf(e,Hf(`model.onnx`,t),n,r).catch(()=>null);if(o)return{mode:`ctc`,ctcModel:o};throw Error(`Could not resolve nemo-conformer RNNT or CTC artifacts.`)}async function tp(e,t,n,r){let i=Hf(`am-onnx/encoder.onnx`,t),a=Hf(`am/encoder.onnx`,t),o=await Jf(e,[...i,...a],n,r).then(e=>e.includes(`/am-onnx/`)?`am-onnx`:`am`).catch(()=>null);return o?{encoder:await Jf(e,Hf(`${o}/encoder.onnx`,t),n,r),decoder:await Jf(e,Hf(`${o}/decoder.onnx`,t),n,r),joiner:await Jf(e,Hf(`${o}/joiner.onnx`,t),n,r),tokensText:await Wf(await Jf(e,[`lang/tokens.txt`,`tokens.txt`],n,r),n,r)}:null}function np(e={}){return e.vadModel??e.vad??null}function rp(e,t={}){let n=np(t);return n?Bf(e,n,t.vadOptions):e}async function ip(e,t={}){return rp(await Mf(e),t)}async function ap(e,t={}){let n=t.fetch??globalThis.fetch;if(!n)throw Error(`No fetch implementation available.`);let r=t.quantization??`int8`,i=t.headers,a=await Gf(Uf(e,`config.json`),n,i);if(!a){let a=await tp(e,r,n,i);if(!a)throw Error(`Could not detect model type: missing config.json and no sherpa am-onnx/am files.`);return ip({modelType:`sherpa-transducer`,decoderKind:`sherpa-transducer`,config:{sample_rate:t.sampleRate??16e3,max_tokens_per_step:10},encoderModel:a.encoder,decoderModel:a.decoder,decoderJointModel:a.joiner,vocabularyText:a.tokensText,sessionOptions:t.sessionOptions,decoderOptions:t.decoderOptions},t)}let o=Pf(a),{modelType:s,spec:c}=Ff(o);if(c.decoderKind===`whisper-ort`){let r=await Jf(e,t.whisperModelCandidates??[`whisper-base_beamsearch.int8.onnx`,`whisper-base_beamsearch.onnx`],n,i),a=await Wf(Uf(e,`vocab.json`),n,i),l=await Kf(Uf(e,`added_tokens.json`),n,i)?await Wf(Uf(e,`added_tokens.json`),n,i):`{}`;return ip({modelType:s,decoderKind:c.decoderKind,config:o,whisperModel:r,vocabJson:a,addedTokensJson:l,sessionOptions:t.sessionOptions,decoderOptions:t.decoderOptions},t)}if(c.decoderKind===`whisper-hf`){let a=Vf(c.encoder,`whisper config is missing encoder model path.`),l=Vf(c.decoderJoint,`whisper config is missing decoder model path.`),[u,d,f,p]=await Promise.all([qf(e,a,{fetchImpl:n,headers:i,quantization:r}),qf(e,l,{fetchImpl:n,headers:i,quantization:r}),Wf(Uf(e,`vocab.json`),n,i),Kf(Uf(e,`added_tokens.json`),n,i)]);return ip({modelType:s,decoderKind:c.decoderKind,config:o,encoderModel:u,decoderJointModel:d,vocabJson:f,addedTokensJson:p?await Wf(Uf(e,`added_tokens.json`),n,i):`{}`,sessionOptions:t.sessionOptions,decoderOptions:t.decoderOptions},t)}if(c.decoderKind===`gigaam`){let a=await $f(e,o,r,n,i);return a.mode===`rnnt`?ip({modelType:s,decoderKind:`gigaam-rnnt`,config:o,encoderModel:a.encoder,decoderModel:a.decoder,decoderJointModel:a.joint,vocabularyText:a.vocabularyText,sessionOptions:t.sessionOptions,decoderOptions:t.decoderOptions},t):ip({modelType:s,decoderKind:`ctc`,config:o,encoderModel:a.ctcModel,vocabularyText:a.vocabularyText,sessionOptions:t.sessionOptions,decoderOptions:t.decoderOptions},t)}if(c.decoderKind===`nemo-conformer`){let a=await ep(e,r,n,i),l=await Yf(e,c.vocabCandidates,n,i);return a.mode===`rnnt`?ip({modelType:s,decoderKind:`rnnt`,config:o,encoderModel:a.encoder,decoderJointModel:a.decoderJoint,vocabularyText:l,sessionOptions:t.sessionOptions,decoderOptions:t.decoderOptions},t):ip({modelType:s,decoderKind:`ctc`,config:o,encoderModel:a.ctcModel,vocabularyText:l,sessionOptions:t.sessionOptions,decoderOptions:t.decoderOptions},t)}let[l,u,d,f]=await Promise.all([qf(e,Vf(c.encoder,`model type '${s}' is missing encoder path.`),{fetchImpl:n,headers:i,quantization:r}),c.decoderJoint?qf(e,c.decoderJoint,{fetchImpl:n,headers:i,quantization:r}):Promise.resolve(null),(async()=>{let t=If(o);if(t)return t;let r=await Yf(e,c.vocabCandidates,n,i);return c.vocabCandidates.includes(`vocab.json`)&&r.trim().startsWith(`{`)?Xf(r):r})(),c.preprocessor?qf(e,c.preprocessor,{fetchImpl:n,headers:i,quantization:r}):Promise.resolve(null)]);return ip({modelType:s,decoderKind:c.decoderKind,config:o,preprocessorModel:f,encoderModel:l,decoderJointModel:u,vocabularyText:d,sessionOptions:t.sessionOptions,decoderOptions:t.decoderOptions},t)}async function op(e,t={}){let n=t.fetch??globalThis.fetch;if(!n)throw Error(`No fetch implementation available.`);let r=t.revision??`main`,i=(t.endpoint??`https://huggingface.co`).replace(/\/$/,``),a=t.hfToken?{...t.headers??{},Authorization:`Bearer ${t.hfToken}`}:t.headers,o=`${i}/${e}/resolve/${encodeURIComponent(r)}/`;if(t.skipRepoListing)return ap(o,{...t,headers:a,fetch:n});let s=await Gf(Uf(o,`config.json`),n,a);if(!s)return ap(o,{...t,headers:a,fetch:n});let c=Pf(s),{modelType:l,spec:u}=Ff(c);if(u.decoderKind===`whisper-ort`){let s=await Zf(e,r,i,n,a),d=Qf(s,t.quantization??`int8`);if(!d)throw Error(`Could not find whisper-ort beamsearch ONNX in Hugging Face repo.`);return ip({modelType:l,decoderKind:u.decoderKind,config:c,whisperModel:Uf(o,d),vocabJson:await Wf(Uf(o,`vocab.json`),n,a),addedTokensJson:s.has(`added_tokens.json`)?await Wf(Uf(o,`added_tokens.json`),n,a):`{}`,sessionOptions:t.sessionOptions,decoderOptions:t.decoderOptions},t)}return ap(o,{...t,headers:a,fetch:n})}let sp=`Olicorne/parakeet-tdt-0.6b-v3-smoothquant-onnx`;ff({wasmPaths:`https://cdn.jsdelivr.net/npm/onnxruntime-web@1.27.0/dist/`,numThreads:globalThis.crossOriginIsolated?Math.max(1,Math.min(8,globalThis.navigator?.hardwareConcurrency||4)):1,simd:!0,proxy:!1});let cp=null,lp=null;function up(e){self.postMessage(e)}function dp(e=``){return String(e||``).replace(/\s+/g,` `).replace(/\s+([,.;!?])/g,`$1`).trim()}async function fp(e){if(cp)return cp;if(lp)return lp;lp=(async()=>{up({type:`phase`,requestId:e,phase:`loading-asr`,label:`Loading Parakeet TDT`}),up({type:`progress`,requestId:e,stage:`parakeet`,label:`Parakeet TDT 0.6B v3`,event:{file:`Parakeet multilingual INT8`,loaded:0,total:0,progress:null}});let t=await op(sp,{revision:`main`,quantization:`int8`,sessionOptions:{executionProviders:[`wasm`],graphOptimizationLevel:`all`,enableCpuMemArena:!0},decoderOptions:{maxSymbols:10}});return cp=t,up({type:`phase`,requestId:e,phase:`asr-ready`,label:`Parakeet ready`}),t})();try{return await lp}catch(e){throw cp=null,e}finally{lp=null}}async function pp(e,t,n,r={}){let i=await fp(e),a=new Float32Array(t),o=Number(n)||16e3;up({type:`phase`,requestId:e,phase:`transcribing`,label:`Transcribing with Parakeet`});let s=await i.transcribeSamples(a,o),c=dp(s?.text||``);console.info(`[BlackRiver Voice] Parakeet transcript`,{repository:sp,sampleRate:o,samples:a.length,duration:a.length/o,transcript:c,words:s?.words?.length||0}),up({type:`raw`,requestId:e,raw:c,asr:`parakeet-tdt-0.6b-v3-smoothquant`}),up({type:`result`,requestId:e,raw:c,cleaned:c,mode:r.mode===`raw`?`raw`:r.mode===`prompt`?`prompt`:`natural`,asr:`parakeet-tdt-0.6b-v3-smoothquant`,needsRefine:r.mode!==`raw`,words:s?.words||[]})}self.onmessage=async({data:e})=>{let t=e?.requestId;try{if(e?.type===`load`){await fp(t),up({type:`ready`,requestId:t});return}e?.type===`transcribe`&&await pp(t,e.audio,e.sampleRate,e.settings||{})}catch(e){console.error(`[BlackRiver Voice] Parakeet worker failed`,e),up({type:`error`,requestId:t,message:e?.message||String(e)||`BlackRiver Voice failed.`,name:e?.name||`Error`})}}})();
//# sourceMappingURL=voice-worker-BpuimIM4.js.map